"use strict";
(self["webpackChunkportal"] = self["webpackChunkportal"] || []).push([["5847"], {
...
9936(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
function useSearchQuery() {
    ...
    return {
        searchValue,
        searchContext: searchContext && Array.isArray((/* inlined export .searchContextByPaths */null)) && (/* inlined export .searchContextByPaths.some */null).some((item)=>typeof item === "string" ? item === searchContext : item.path === searchContext) ? searchContext : "",
        searchVersion,
...
var concatDocumentPath = __webpack_require__(8127);
...
var normalizeContextByPath = __webpack_require__(9553);
...
function SearchPageContent() {
    ...
    (0,react.useEffect)(()=>{
        async function doFetchIndexes() {
            if (!Array.isArray((/* inlined export .searchContextByPaths */null)) || searchContext || (/* inlined export .useAllContextsWithNoSearchContext */false)) {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                className: (0,clsx/* ["default"] */.A)("col", {
                                    [SearchPage_module.searchQueryColumn]: Array.isArray((/* inlined export .searchContextByPaths */null)),
                                    "col--9": Array.isArray((/* inlined export .searchContextByPaths */null)),
                                    "col--12": !Array.isArray((/* inlined export .searchContextByPaths */null))
                                }),
                            ...
                            Array.isArray((/* inlined export .searchContextByPaths */null)) ? /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                ...
                                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("select", {
                                    ...
                                    children: [
                                        (/* inlined export .useAllContextsWithNoSearchContext */false) && /*#__PURE__*/ (0,jsx_runtime.jsx)("option", {
                                            value: "",
                                        ...
                                        (/* inlined export .searchContextByPaths.map */null).map((context)=>{
...
function SearchResultItem({ searchResult: { document, type, page, tokens, metadata } }) {
    ...
    let search = "";
    if ((/* inlined export .Mark */null) && tokens.length > 0) {
