...
86897(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  BH: () => (language),
  IH: () => (searchIndexUrl),
  sx: () => (removeDefaultStopWordFilter)
});
const removeDefaultStopWordFilter = [];
const language = [
    "en"
];
const searchIndexUrl = "search-index{dir}.json?_=f261ff40";
...
var __webpack_exports__ = __webpack_require__.O(undefined, ["51852"], () => __webpack_require__(95655));
...
__webpack_require__.u = (chunkId) => {
  ...
  return "assets/js/" + chunkId + "." + "e7c1dc02" + ".js"
}
})();
...
__webpack_require__.x = () => {
  return __webpack_require__.e("51852").then(next);
}
})();
