...
| P-REPO-IA | Repository layout SoT: [IA policy](docs/governance/standards/repository-information-architecture-policy.md) + [path manifest](docs/maintenance/repository-path-manifest.json) — do not add top-level dirs without policy class | [FR-140](docs/kanban/fbu/FR-140-repository-information-architecture-steady-state-governance.md) · [ADR-033](docs/architecture/standards-and-adrs/ADR-033-repository-information-architecture-layered-governance.md) |
