...
**Version Context:** v0.7.1.11+1 (**SemVer** v0.4.815+1)
...
- **FR-101** – Consolidate governance under `docs/governance/` - 📋 OPEN (HIGH, Phase 0 inventory **v0.7.1.11+1**; maintainer sign-off before `git mv`) | [FR-101](fr-br/FR-101-consolidate-governance-under-docs-governance.md) | [E7:S01:T11](epics/Epic-7/Story-001-codebase-maintenance-tasks/T11-consolidate-governance-under-docs-governance-fr101.md) | —No IPP— | Last modified: 2026-05-29 15:12 UTC
