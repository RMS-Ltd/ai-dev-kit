...
| Metric | Count |
|--------|------:|
| Unique tasks (`E:S:T`) | 377 |
| Named titles | 336 (89.1%) |
| Unresolved titles | 41 |
| Epic bands | 19 |

**Rules applied:**
- One row per native `E:S:T` (first-seen title wins; longest named title on conflict).
- Tasks grouped under **native** epic/story from task ID (not display band header).
- UAT sections under E08 → canonical story home **E41** (same S/T numbers).
- E36:S01–S10 story shells injected from epic-36 checklist.
- E36:S06+ task rows merged from epic body `####` headers when missing from temp.

---

## E01 — Repository Infrastructure & Maintenance (4S · 42T)
...
### E03:S05 – Story 4: Kanban Process Governance [E03:S05]
...
## E06 — Process Automation & CI/CD (2S · 3T)
...
## E33 — Colonies & Population (5S · 38T)
...
## E34 — Ship Design & Construction (14S · 115T)
...
## E35 — Warfare, AI & Turn Loop (1S · 10T)
...
## E36 — Intelligence, Sensors & Diplomacy (10S · 11T)

### E36:S01 – Design sensor range & visibility system [E36:S01]
- *(tasks pending fan-out)*
...
## E37 — Session, Scenario & Starting Conditions (1S · 2T)
...
## E38 — Player UI & Experience (2S · 8T)

### E34:S04 – Rich Ship Screen [E38:S04]
