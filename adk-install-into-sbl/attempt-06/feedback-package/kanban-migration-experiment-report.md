...
| Upstream filed | **F22** → [FR-127](../../../docs/kanban/fr-br/FR-127-agentic-kanban-migration-agent-replace-tool-pipeline.md) / [T31](../../../docs/kanban/epics/epic-06/story-09-ai-dev-kit-installation-and-adopter-integration/T31-agentic-kanban-migration-agent-fr127.md) |
| Upstream filed | **F23** → [BR-108](../../../docs/kanban/fr-br/BR-108-detect-existing-structure-zero-padded-epic-names.md) / [T32](../../../docs/kanban/epics/epic-06/story-09-ai-dev-kit-installation-and-adopter-integration/T32-detect-structure-zero-padded-epic-br108.md) |
