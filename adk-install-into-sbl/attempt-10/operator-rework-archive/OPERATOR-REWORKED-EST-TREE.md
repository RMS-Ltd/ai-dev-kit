...
# Operator-reworked E/S/T tree (attempt 10 lineage)

**Role:** Side **B** in the blind-KMA → operator-rework comparison ([COMPARISON.md](COMPARISON.md)).

**Recovery:** Copied from Starborn Legacy local `temp/sbl-operator-kanban-est-tree-titled.md` (2026-06-16). That path is **gitignored on SBL** and was **not** attached to closed [#52](https://github.com/RMS-Ltd/ai-dev-kit/issues/52) / [#57](https://github.com/RMS-Ltd/ai-dev-kit/issues/57) — issues link `KMA-REFERENCE-EST-TREE-ATTEMPT-09.md` on SBL `dev` only.

**Lineage:** Attempt-09 operator freeze ([`KMA-REFERENCE-EST-TREE-ATTEMPT-09.md`](../../attempt-09/feedback-package/KMA-REFERENCE-EST-TREE-ATTEMPT-09.md)) + legacy title resolution; attempt-10 **pass-2 filesystem tweaks** are logged in [FB §4](../feedback-package/FB-ADK-KMA-KANBAN-MIGRATION.md#4-operator-tweaks-log) (E15 routing, `story-NN-legacy-*`, E31 synthesis, E30+ titles).
