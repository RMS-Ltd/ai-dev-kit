---
name: adk-intake-fr-br-uxr
description: ADK intake for FR/BR/UXR into Kanban tasks (atomic, bidirectional).
origin: ai-dev-kit
---
...
Primary reference: [`intake-workflow-agent-execution.md`](../../KB/Documentation/Developer_Docs/vwmp/intake-workflow-agent-execution.md)
