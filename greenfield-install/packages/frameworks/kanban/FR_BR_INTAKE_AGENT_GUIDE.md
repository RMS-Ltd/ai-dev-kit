...
- **Location:** Story document (`docs/kanban/epics/Epic-X/stories/Story-XXX-*.md`)
...
- **Action:** Read `docs/kanban/_index.md` or `kboard.md`
...
- **Kanban Index:** `docs/kanban/_index.md`
