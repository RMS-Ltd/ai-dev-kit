...
# Setup locale index (en-US)

**Locale:** US English (`en-US` / `US`)
...
2. **Persist** — `ai-dev-kit-config.yaml` at project root (`localisation.language: en-US`).
...
FR, BR, UXR, FB, TASK, STORY, EPIC, PLAN_DOC — US spelling in instructional prose (color, organize, realize).
