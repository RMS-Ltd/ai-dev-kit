...
# Epic 7, Story 3, Task 2: Set up feedback collection channels (in-app, surveys, support)

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.7.3.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E07:S03:T02` (e.g., `E04:S11:T01`)
...
Set up feedback collection channels (in-app, surveys, support) for the {PROJECT_NAME} project.
...
- set up feedback collection channels (in-app, surveys, support) requirements
...
- set up feedback collection channels (in-app, surveys, support) completed
...
- [ ] Set up feedback collection channels (in-app, surveys, support) completed successfully
...
1. Analyze requirements for set up feedback collection channels (in-app, surveys, support)
2. Design approach and plan
3. Implement set up feedback collection channels (in-app, surveys, support)
4. Test and validate
...
- **[E07:S03:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E07:S03:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
