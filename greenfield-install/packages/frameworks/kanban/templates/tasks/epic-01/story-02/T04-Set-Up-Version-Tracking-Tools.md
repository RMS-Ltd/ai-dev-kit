...
# Epic 1, Story 2, Task 4: Set up version tracking tools
...
**Format:** `E01:S02:T04` (e.g., `E04:S11:T01`)
...
- **[E01:S02:T04: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E01:S02:T04: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
