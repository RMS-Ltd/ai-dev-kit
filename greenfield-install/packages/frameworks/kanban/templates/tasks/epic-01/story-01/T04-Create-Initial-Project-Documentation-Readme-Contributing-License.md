...
**Last updated:** [YYYY-MM-DD] (v0.1.1.4+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E01:S01:T04` (e.g., `E04:S11:T01`)
...
Create initial project documentation (README, CONTRIBUTING, LICENSE) for the {PROJECT_NAME} project.
...
- create initial project documentation (readme, contributing, license) requirements
...
- create initial project documentation (readme, contributing, license) completed
...
- [ ] Create initial project documentation (README, CONTRIBUTING, LICENSE) completed successfully
...
1. Analyze requirements for create initial project documentation (readme, contributing, license)
2. Design approach and plan
3. Implement create initial project documentation (readme, contributing, license)
4. Test and validate
...
- **[E01:S01:T04: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E01:S01:T04: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
