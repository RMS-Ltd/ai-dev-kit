...
# Epic 9, Story 2, Task 5: Create video tutorials (optional)
...
**Format:** `E09:S02:T05` (e.g., `E04:S11:T01`)
...
Create video tutorials (optional) for the {PROJECT_NAME} project.
...
- create video tutorials (optional) completed
...
- [ ] Create video tutorials (optional) completed successfully
...
1. Analyze requirements for create video tutorials (optional)
2. Design approach and plan
3. Implement create video tutorials (optional)
4. Test and validate
...
- **[E09:S02:T05: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S02:T05: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
