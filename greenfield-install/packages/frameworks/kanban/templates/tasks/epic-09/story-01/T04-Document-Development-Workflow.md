...
**Format:** `E09:S01:T04` (e.g., `E04:S11:T01`)
...
Document development workflow for the {PROJECT_NAME} project.
...
- document development workflow completed
...
- [ ] Document development workflow completed successfully
...
1. Analyze requirements for document development workflow
2. Design approach and plan
3. Implement document development workflow
4. Test and validate
...
- **[E09:S01:T04: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S01:T04: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
