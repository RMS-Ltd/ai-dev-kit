...
# Epic 3, Story 1, Task 2: Document versioning policy

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.3.1.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E03:S01:T02` (e.g., `E04:S11:T01`)
...
Document versioning policy for the {PROJECT_NAME} project.
...
- document versioning policy requirements
...
- document versioning policy completed
...
- [ ] Document versioning policy completed successfully
...
1. Analyze requirements for document versioning policy
2. Design approach and plan
3. Implement document versioning policy
4. Test and validate
...
- **[E03:S01:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E03:S01:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
