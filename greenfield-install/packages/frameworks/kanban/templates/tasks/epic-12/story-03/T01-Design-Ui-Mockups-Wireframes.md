...
# Epic 12, Story 3, Task 1: Design UI mockups/wireframes

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.12.3.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E12:S03:T01` (e.g., `E04:S11:T01`)
...
Design UI mockups/wireframes for the {PROJECT_NAME} project.
...
- design ui mockups/wireframes requirements
...
- design ui mockups/wireframes completed
...
- [ ] Design UI mockups/wireframes completed successfully
...
1. Analyze requirements for design ui mockups/wireframes
2. Design approach and plan
3. Implement design ui mockups/wireframes
4. Test and validate
...
- **[E12:S03:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E12:S03:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
