...
# Epic 14, Story 1, Task 3: Configure deployment environments (dev/staging/prod)

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.14.1.3+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
Configure deployment environments (dev/staging/prod) for the {PROJECT_NAME} project.
...
- configure deployment environments (dev/staging/prod) requirements
...
- configure deployment environments (dev/staging/prod) completed
...
- [ ] Configure deployment environments (dev/staging/prod) completed successfully
...
1. Analyze requirements for configure deployment environments (dev/staging/prod)
2. Design approach and plan
3. Implement configure deployment environments (dev/staging/prod)
4. Test and validate
...
- **[E14:S01:T03: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E14:S01:T03: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
