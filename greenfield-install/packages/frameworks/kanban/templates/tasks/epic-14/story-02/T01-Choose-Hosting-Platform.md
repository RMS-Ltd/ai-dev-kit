...
# Epic 14, Story 2, Task 1: Choose hosting platform

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.14.2.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E14:S02:T01` (e.g., `E04:S11:T01`)
...
Choose hosting platform for the {PROJECT_NAME} project.
...
- choose hosting platform requirements
...
- choose hosting platform completed
...
- [ ] Choose hosting platform completed successfully
...
1. Analyze requirements for choose hosting platform
2. Design approach and plan
3. Implement choose hosting platform
4. Test and validate
...
- **[E14:S02:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E14:S02:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
