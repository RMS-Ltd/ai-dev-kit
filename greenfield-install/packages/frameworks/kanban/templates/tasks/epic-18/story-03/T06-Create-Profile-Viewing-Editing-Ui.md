...
# Epic 18, Story 3, Task 6: Create profile viewing/editing UI

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.3.6+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S03:T06` (e.g., `E04:S11:T01`)

**Full Task ID:** `E18:S03:T06`
...
- **[E18:S03:T06: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S03:T06: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
