...
# Epic 18, Story 2, Task 5: Add permission checking utilities

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.2.5+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S02:T05` (e.g., `E04:S11:T01`)
...
- **[E18:S02:T05: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S02:T05: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
