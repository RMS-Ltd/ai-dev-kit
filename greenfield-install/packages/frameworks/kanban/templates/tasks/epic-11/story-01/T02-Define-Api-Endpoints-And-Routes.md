...
# Epic 11, Story 1, Task 2: Define API endpoints and routes

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.11.1.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E11:S01:T02` (e.g., `E04:S11:T01`)
...
Define API endpoints and routes for the {PROJECT_NAME} project.
...
- define api endpoints and routes requirements
...
- define api endpoints and routes completed
...
- [ ] Define API endpoints and routes completed successfully
...
1. Analyze requirements for define api endpoints and routes
2. Design approach and plan
3. Implement define api endpoints and routes
4. Test and validate
...
- **[E11:S01:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E11:S01:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
