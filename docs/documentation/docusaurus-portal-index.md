...
This file is the **default entry** for the Docusaurus docs plugin, which publishes the repository **[`docs/` tree](https://github.com/RMS-Ltd/ai-dev-kit/tree/main/docs)** (**FR-066**).
