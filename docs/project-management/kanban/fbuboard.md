...
**Last Updated:** 2026-06-03 (RW **E08:S03:T06** — v0.8.3.6+1)
**Version Context:** v0.8.3.6+1 (**SemVer** v0.4.851+1)
...
- **BR-077** – Documented Python 3.8+ contradicts repo 3.10+ requirement - 🟢 OPEN (HIGH, Must Have — metadata/doc bug; closed via **FR-104** / **E08:S03:T05**) | [BR-077](fr-br/BR-077-documented-python-38-contradicts-repo-310-requirement.md) | [FR-104](fr-br/FR-104-python-minimum-version-policy-alignment.md) | [E08:S03:T05](epics/Epic-8/Story-003-automation-scripts/T05-python-minimum-version-fr104-br077.md) | —No IPP— | Last modified: 2026-06-03 15:49 UTC
