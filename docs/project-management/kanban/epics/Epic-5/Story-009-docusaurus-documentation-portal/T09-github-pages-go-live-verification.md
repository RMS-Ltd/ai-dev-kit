...
Make the Docusaurus site **actually served** from GitHub Pages and **prove** it: repo **Settings → Pages**, confirm deploy workflow health, verify **`https://rms-ltd.github.io/ai-dev-kit/`** (and key paths), update docs if discoverability steps are wrong or incomplete.
...
- **Documentation** — **Go-live and troubleshooting** under [portal/README.md](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/portal/README.md) (FR-070).
