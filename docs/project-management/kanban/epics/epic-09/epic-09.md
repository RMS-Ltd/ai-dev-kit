...
- [ ] **E9:S01 – RC Readiness Gap Analysis** - IN PROGRESS (v0.9.1.8+9 – T08 COMPLETE: Final validation complete - Kanban board S00→S01 references fixed, versioning policy E6:S06→E6:S07 corrected, acceptance criteria marked complete)
  - Story: [`story-01-rc-readiness-gap-analysis.md`](story-01-rc-readiness-gap-analysis.md)


- [ ] **E9:S02 – Kanban Framework RC Readiness Review** - TODO
  - Story: [`story-02-kanban-framework-rc-readiness-review.md`](story-02-kanban-framework-rc-readiness-review.md)


- [ ] **E9:S03 – Workflow Management Framework RC Readiness Review** - TODO
  - Story: [`story-03-workflow-management-framework-rc-readiness-review.md`](story-03-workflow-management-framework-rc-readiness-review.md)


- [ ] **E9:S04 – Numbering & Versioning Framework RC Readiness Review** - TODO
  - Story: [`story-04-numbering-versioning-framework-rc-readiness-review.md`](story-04-numbering-versioning-framework-rc-readiness-review.md)


- [x] **E9:S05 – Canonical E/S/T Review and Refinement** - COMPLETE (v0.9.5.4+2 – T04 COMPLETE: UXR-011 kanban naming hygiene and directory systematic cleanup; regression validator green; all 10 ACs satisfied; story goal attained)
  - Story: [`story-05-canonical-est-review-and-refinement.md`](story-05-canonical-est-review-and-refinement.md)
  - Tasks: T01-T04 (T04: COMPLETE)
...
**Story Document:** [`story-01-rc-readiness-gap-analysis.md`](story-01-rc-readiness-gap-analysis.md)
...
**Story Document:** [`story-02-kanban-framework-rc-readiness-review.md`](story-02-kanban-framework-rc-readiness-review.md)
...
**Story Document:** [`story-03-workflow-management-framework-rc-readiness-review.md`](story-03-workflow-management-framework-rc-readiness-review.md)
...
**Story Document:** [`story-04-numbering-versioning-framework-rc-readiness-review.md`](story-04-numbering-versioning-framework-rc-readiness-review.md)
...
**Story Document:** [`story-05-canonical-est-review-and-refinement.md`](story-05-canonical-est-review-and-refinement.md)
...
- **Epic 1:** `docs/project-management/kanban/epics/epic-01/epic-01.md` - AI Dev Kit Core
- **Epic 2:** `docs/project-management/kanban/epics/epic-02/epic-02.md` - Workflow Management Framework
- **Epic 3:** `docs/project-management/kanban/epics/epic-03/epic-03.md` - Numbering & Versioning Framework
- **Epic 4:** `docs/project-management/kanban/epics/epic-04/epic-04.md` - Kanban Framework
