...
- [ ] All 14 suggestions triaged (apply / dismiss / defer-to-BR-099|100).
- [ ] Valid suggestions implemented; CI green.
- [ ] AI suggestions panel shows 0 open items.
- [ ] **BR-101** released via **RW E08:S03:T14** when complete.
