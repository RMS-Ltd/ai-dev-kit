...
- [x] **AC4:** Reference map identifies all docs/policies/validator surfaces requiring migration edits. *(IPP §2.6: ACTIVE_FIX / ARCHIVE_STUB / DEFER + `Epic-6/Story-007` counts.)*
...
| `Epic-6/Story-007` under `docs/` | 167 occurrences, 101 files |
