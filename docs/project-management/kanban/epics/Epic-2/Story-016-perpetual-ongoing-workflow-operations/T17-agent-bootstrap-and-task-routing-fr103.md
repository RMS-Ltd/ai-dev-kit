...
- [x] **AC6:** FR-103 ↔ E02:S16:T17 bidirectional links; story checklist + board rows present.
- [x] **AC7:** IPP exists and is linked here before implementation execution (`IPW E02:S16:T17`).
