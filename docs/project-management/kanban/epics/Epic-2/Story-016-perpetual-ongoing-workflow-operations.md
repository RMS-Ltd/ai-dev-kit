...
**Created:** 2026-04-20  
**Last updated:** 2026-05-30 (v0.2.16.16+1 – Kanban documentation setup)
...
Story 016 remains the operational home for perpetual workflow work. Recent delivery closed **E02:S16:T06** (FR-085: UKW `--rp` deep reprioritization) at **v0.2.16.6+1** (ADR-009, agent SoT, cheatsheet). Prior: **T15** cheatsheet (v0.2.16.15+1), **T11** (FR-096 IPW §5–§7). Active lanes: **T02**, **T03**, **T04**, **T05**, **T07** (FR-050, TODO), **T10**. **COMPLETE** discrete tasks include T01, T06, T08, T09, T11, T15.
...
- [x] **E02:S16:T06 – UKW optional reprioritization `--rp` flag (FR-085)** - ✅ COMPLETE (v0.2.16.6+1 — ADR-009, standalone `UKW --rp`, cheatsheet + agent SoT)  
  - Task: [`Story-016-perpetual-ongoing-workflow-operations/T06-ukw-optional-reprioritization-rp-flag-fr085.md`](Story-016-perpetual-ongoing-workflow-operations/T06-ukw-optional-reprioritization-rp-flag-fr085.md) | [FR-085](../../fr-br/FR-085-ukw-optional-reprioritization-rp-flag.md) | [IPP](../../../implementation-cycles/IPP-E02S16T06-ukw-rp-flag-fr085.md)
...
- [ ] **E02:S16:T16 – UKW archive completed rows (`-c`) (FR-102)** - TODO (HIGH, kanban init **v0.2.16.16+1**; `UKW -c`: kboard/fbuboard → kanban-completed/fbu-completed before active MoSCOW removal)  
  - Task: [`Story-016-perpetual-ongoing-workflow-operations/T16-ukw-archive-completed-board-rows-fr102.md`](Story-016-perpetual-ongoing-workflow-operations/T16-ukw-archive-completed-board-rows-fr102.md) | [FR-102](../../fr-br/FR-102-ukw-archive-completed-board-rows.md)
