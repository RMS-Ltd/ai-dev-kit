...
- [ ] **E3:S04 – Numbering & Versioning Package Implementation Review** - IN PROGRESS (v0.3.4.6+1 – T06: RC sign-off criteria and remediation tasks complete)
  - Story: [`story-04-numbering-versioning-package-implementation-review.md`](story-04-numbering-versioning-package-implementation-review.md)
...
- [ ] **E3:S05 – Numbering & Versioning Package Installation Evaluation** - TODO (v0.3.5.0+0)
  - Story: [`story-05-numbering-versioning-package-installation-evaluation.md`](story-05-numbering-versioning-package-installation-evaluation.md)
...
> Full story: [`story-01-dev-kit-alignment-with-versioning-framework.md`](story-01-dev-kit-alignment-with-versioning-framework.md)
...
> Full story: [`story-02-versioning-cookbook-and-examples.md`](story-02-versioning-cookbook-and-examples.md)
...
> Full story: [`story-03-versioning-integration-with-kanban-and-rw.md`](story-03-versioning-integration-with-kanban-and-rw.md)
