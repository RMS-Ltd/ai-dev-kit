...
Repository anchor for **UXR-006** (MoSCOW row `Last modified` UTC stamps); delivery tracked on **E06:S06:T61**.
...
- [E06:S06:T61](../../Epic-6/Story-006-feature-requests/T61-uxr-006-kanban-moscow-last-modified-stamps.md)

---

## Deliverable

- Stable **E07:S00:T06** pointer in UXR header and **`fbuboard.md`** MoSCOW row.  
- **`RW -k`** when an abstract-space registry release is required; primary product releases use **E06:S06:T61**.
...
- [x] **AC2:** UXR-006 lists **E07:S00:T06** and **E06:S06:T61** in header.  
...
**Related:** E06:S06:T61 (implementation).
