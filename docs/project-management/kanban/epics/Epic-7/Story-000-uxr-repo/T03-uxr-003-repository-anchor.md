...
Canonical **repository** task for **UXR-003** per [Story-000-uxr-repo](../Story-000-uxr-repo.md). Intake/version anchors and bidirectional links; synthesis and requirements live under **E07:S05:T03**.
...
- [E07:S05:T03](../Story-005-migration-uxr-research.md) (synthesis complete)

---

## Deliverable

- Intake-complete headers on UXR + this task; **`RW -k`** when first **repository-slot** versioned release is required on **epic/7**.  
- Cross-links: UXR-003 ↔ **T03** ↔ **E07:S05:T03** on FR/UXR board and MoSCOW rows.
