...
- `docs/project-management/kanban/epics/Epic-4/Epic-4.md` (Epic document)
- `docs/project-management/kanban/Story-003-kanban-versioning-rw-integration.md` (Story document)
