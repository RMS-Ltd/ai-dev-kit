...
- [ ] **E04:S11:T07 – Migrate Embedded Tasks to Discrete Task Documents** - IN PROGRESS (v0.4.11.7+6 – Wave 1 tooling shipped; pilot migration Wave 2 pending)
...
- ✅ Phase 5: Review existing Epic/Story/Task docs for compliance (audit complete: epic-04.md and epic-02.md violations documented)
...
- **E2:S09:** `docs/project-management/kanban/epics/epic-02/story-09-kanban-granularity-discrete-task-docs.md`
