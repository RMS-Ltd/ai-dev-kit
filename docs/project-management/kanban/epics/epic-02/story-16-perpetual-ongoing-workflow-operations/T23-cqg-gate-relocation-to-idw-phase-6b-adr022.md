...
**Upstream:** [ADR-022 v0.0.2 — Local Code Quality Gate architecture](../../../../../architecture/standards-and-adrs/ADR-022-local-code-quality-gate-architecture.md) (operator directive) · [FR-113](../../../fr-br/FR-113-local-code-quality-gate-cqg.md) · [FR-118](../../../fr-br/FR-118-implementation-delivery-workflow-idw.md) · follow-on to [E02:S16:T22](T22-implementation-delivery-workflow-idw-fr118.md) · [E08:S03:T17](../../epic-08/story-03-automation-scripts/T17-local-code-quality-gate-cqg-fr113.md)
...
- [FR-118](../../../fr-br/FR-118-implementation-delivery-workflow-idw.md)
