...
# Story 006 – RTL and Extended Locales
...
Populate `locales/ar/` and `locales/ru/` with framework user-facing content. Arabic delivery coordinates with E21:S03:T03 (RTL support).

---

## Task Checklist

- [ ] **E21:S06:T01 – Arabic (ar) translation files** - TODO
  - Task: [`T01-arabic-ar-translation-files`](story-06-rtl-and-extended-locales/T01-arabic-ar-translation-files.md)
- [ ] **E21:S06:T02 – Russian (ru) translation files** - TODO
  - Task: [`T02-russian-ru-translation-files`](story-06-rtl-and-extended-locales/T02-russian-ru-translation-files.md)
...
**Coordinates With:**
- E21:S03:T03: RTL support (Arabic)
...
- `docs/project-management/kanban/epics/epic-21/story-03-cultural-adaptation.md`
