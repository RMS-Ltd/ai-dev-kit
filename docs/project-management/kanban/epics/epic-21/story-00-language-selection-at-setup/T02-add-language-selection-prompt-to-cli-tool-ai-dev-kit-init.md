...
# Epic 21, Story 0, Task 2: Add language selection prompt to CLI tool (`ai-dev-kit init`)
...
```text
RW -k E21:S00:T02 --art --dpz
```

**Target version anchor:** `v0.21.0.2+0` (doc-init BUILD +0 per [BR-067](../../../fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md)).
