...
# Epic 21, Story 0, Task 7: Test UK/US English selection and content generation
...
```text
RW -k E21:S00:T07 --art --dpz
```

**Target version anchor:** `v0.21.0.7+0` (doc-init BUILD +0 per [BR-067](../../../fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md)).
