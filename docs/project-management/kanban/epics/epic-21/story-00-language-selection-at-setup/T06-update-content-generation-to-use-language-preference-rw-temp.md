...
# Epic 21, Story 0, Task 6: Update content generation to use language preference (RW, templates)
...
```text
RW -k E21:S00:T06 --art --dpz
```

**Target version anchor:** `v0.21.0.6+0` (doc-init BUILD +0 per [BR-067](../../../fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md)).
...
**Source Story:** `docs/project-management/kanban/epics/epic-21/story-00-language-selection-at-setup.md`
