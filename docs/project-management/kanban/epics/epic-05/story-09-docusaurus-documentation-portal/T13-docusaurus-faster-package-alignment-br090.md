...
- [ ] **`@docusaurus/faster`** present in `portal/package.json` and lockfile.
- [ ] All `@docusaurus/*` portal deps pinned consistently at **3.10.1** (or current lockfile version).
- [ ] **`Docusaurus site build`** workflow green on `main` for portal/docs changes.
- [ ] **`portal/README.md`** updated if install/build steps change.
