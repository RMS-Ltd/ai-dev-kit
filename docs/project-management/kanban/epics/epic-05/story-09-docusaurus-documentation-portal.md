...
- [x] **E05:S09:T13 – Docusaurus `@docusaurus/faster` + package.json 3.10.1 alignment ([BR-090](../../fr-br/BR-090-docusaurus-faster-missing-dependabot-310-lockfile-drift.md))** — ✅ COMPLETE (**v0.5.9.13+2** — Wave 2 build closure); [IPP](../../../../implementation-cycles/IPP-E05S09T13-docusaurus-faster-package-alignment.md) — [task file](story-09-docusaurus-documentation-portal/T13-docusaurus-faster-package-alignment-br090.md)
