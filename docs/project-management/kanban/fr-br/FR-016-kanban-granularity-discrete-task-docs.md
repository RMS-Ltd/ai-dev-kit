...
**Planning package (E04:S11:T07):** [IPP-E04S11T07-fr016-discrete-task-docs-migration.md](../../../implementation-cycles/IPP-E04S11T07-fr016-discrete-task-docs-migration.md) — consolidated IPW plan for phased migration of embedded tasks to discrete Task documents. Status: **IN PROGRESS** (v0.4.11.7+13 — Wave 3 Epics 1–11 complete; Epic 21 pending).
