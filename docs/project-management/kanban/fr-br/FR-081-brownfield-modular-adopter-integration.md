...
- [x] Brownfield adopters can answer: **what must I wire**, **what can I skip**, and **what validators apply** for their chosen surfaces.
- [x] ADR-003 is **referenced** from installation docs as the policy anchor for brownfield behavior.
- [x] At least one **worked example** (hypothetical or anonymized) of partial adoption is documented.
...
- [x] Implementation-only changes (installer epilog + Kanban fresh-mode warning)
