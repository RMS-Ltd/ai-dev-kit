...
- **Perpetual CMW task** today is tracked as **E02:S16:T03**; doc-epic alignment for *where CMW should run* is not spelled out as a hard rule in CMW docs or scripts.
