...
*(E01:S04:T03–T07 archived — [kanban-completed.md](kanban-completed.md). **E06:S09** installer tasks **T07–T13** archived → [kanban-completed.md](kanban-completed.md). **E07:S07:T01** archived **v0.7.7.1+1**. **E02:S13:T08** archived **v0.2.13.8+2**. **E07:S07:T02** released **v0.7.7.2+1** — CI pytest gate H1.)*
