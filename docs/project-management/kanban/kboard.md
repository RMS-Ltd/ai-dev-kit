...
**Last Updated:** 2026-06-07 (RW **v0.2.17.1+2** — T01 scenario matrix)
**Version:** v0.2.17.1+2
...
- **E02:S17:T01** – RW & IPW scenario matrix and run-log schema - 🔄 IN PROGRESS (HIGH, **v0.2.17.1+2** matrix delivered; T02 baseline next) | [Task](epics/epic-02/story-17-rw-semver-characterization-and-release-state-sqlite/T01-rw-ipw-scenario-matrix-and-run-log-schema.md) | [Story](epics/epic-02/story-17-rw-semver-characterization-and-release-state-sqlite.md) | —No IPP— | Last modified: 2026-06-07 17:22 UTC
