...
- **E07:S01:T12** – Promote Kanban to `docs/kanban/`; retire `project-management/` shell (FR-118) - 📋 TODO (HIGH, RC structural hygiene — **v0.7.1.12+1** kanban-init filed) | [Task](epics/epic-07/story-01-codebase-maintenance-tasks/T12-promote-kanban-to-docs-kanban-retire-project-management-fr118.md) | [FR-118](fr-br/FR-118-promote-kanban-to-docs-kanban-retire-project-management-shell.md) | —No IPP— | Last modified: 2026-06-08 12:31 UTC
