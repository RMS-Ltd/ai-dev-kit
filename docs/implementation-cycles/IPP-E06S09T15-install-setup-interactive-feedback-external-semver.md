...
**Planning for:** [UXR-016](../kanban/fbu/UXR-016-install-setup-interactive-feedback-external-semver-version.md) *(reclassified from FR-108)*  
**Status:** Approved
...
- [UXR-016](../kanban/fbu/UXR-016-install-setup-interactive-feedback-external-semver-version.md)
