...
**Planning for:** [FR-003](../kanban/fbu/FR-003-dependency-tracking-in-adopting-projects.md)  
...
**§5.3 governing docs:** [ADR-003](../architecture/standards-and-adrs/ADR-003-greenfield-vs-brownfield-adoption.md); [`packages/frameworks/numbering-versioning/README.md`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/packages/frameworks/numbering-versioning/README.md); [FR-003](../kanban/fbu/FR-003-dependency-tracking-in-adopting-projects.md).
...
- [FR-003](../kanban/fbu/FR-003-dependency-tracking-in-adopting-projects.md)
- [FR-002](../kanban/fbu/FR-002-update-been-there-readme.md) (related README template)
