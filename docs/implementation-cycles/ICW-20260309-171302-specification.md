...
### References
- [FR-045: ADR-002 Task-Touch Derived Mapping](../kanban/fr-br/FR-045-adr-002-task-touch-derived-mapping.md)
- [FR-046: RW Uses SemVer Tag When Task-Touch Enabled](../kanban/fr-br/FR-046-rw-semver-tag-task-touch-mode.md)
- [Release Workflow workflow package (source)](https://github.com/RMS-Ltd/ai-dev-kit/tree/main/packages/frameworks/workflow-mgt/workflows)
- [GitHub Actions Templates (source)](https://github.com/RMS-Ltd/ai-dev-kit/tree/main/packages/frameworks/workflow-mgt/templates/github-actions)
