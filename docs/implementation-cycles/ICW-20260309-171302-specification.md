...
### References
- [FR-045: ADR-002 Task-Touch Derived Mapping](../kanban/fbu/FR-045-adr-002-task-touch-derived-mapping.md)
- [FR-046: RW Uses SemVer Tag When Task-Touch Enabled](../kanban/fbu/FR-046-rw-semver-tag-task-touch-mode.md)
