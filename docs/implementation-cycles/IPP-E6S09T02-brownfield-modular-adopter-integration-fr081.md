...
- **RF3:** README + installer epilog/warnings; link to [rw-validators-consumer-layout.md](../../packages/frameworks/workflow%20mgt/docs/rw-validators-consumer-layout.md).
...
- [rw-validators-consumer-layout.md](../../packages/frameworks/workflow%20mgt/docs/rw-validators-consumer-layout.md)
