...
**Planning for:** [BR-086](../kanban/fbu/BR-086-rw-install-lowercase-fresh-kanban-patterns-signoff.md) · [GitHub #17](https://github.com/RMS-Ltd/ai-dev-kit/issues/17)  
...
**§5.3 governing docs:** [ADR-015](../architecture/standards-and-adrs/ADR-015-kanban-epic-story-path-lowercase-convention.md); [UXR-017](../kanban/fbu/UXR-017-kanban-epic-story-path-lowercase-naming.md); [`kanban_paths.py`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/packages/frameworks/kanban/scripts/kanban_paths.py); [BR-086](../kanban/fbu/BR-086-rw-install-lowercase-fresh-kanban-patterns-signoff.md).
...
| D3 | `docs/kanban/fbu/BR-086-*.md` | UPDATE | Status on fix | RF1–RF8 |
...
- [BR-083](../kanban/fbu/BR-083-rw-install-default-patterns-mismatch-fresh-kanban-layout.md) · [BR-084](../kanban/fbu/BR-084-rw-install-mode-c-missing-task-doc-pattern.md) · [BR-085](../kanban/fbu/BR-085-rw-install-story-pattern-placeholder-loop-fresh-kanban.md)
