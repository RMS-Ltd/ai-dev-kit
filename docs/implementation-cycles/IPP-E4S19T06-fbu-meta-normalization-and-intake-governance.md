...
**Planning for:** [UXR-008](../kanban/fbu/UXR-008-kboard-fbuboard-default-naming-adoption.md), [FR-086](../kanban/fbu/FR-086-canonical-supporting-kanban-fbu-doc-naming-and-fbu-collective-terminology.md), [FR-073](../kanban/fbu/FR-073-fr-br-uxr-board-open-taskless-intake-execution-plan.md)  
...
| [`ICW-E4S19T5-specification.md`](ICW-E4S19T05-specification.md) | E4:S19:T05 (SUPERSEDED, pre-consolidation ICW set) | Folded into unified IPP per [FR-042](../kanban/fbu/FR-042-implementation-planning-workflow-ipw.md) §7 ICW→IPW consolidation | §1, §2 |
...
| ---- | ---- | ---- | ---- |
| `docs/kanban/fbu-uxr-completed.md` | `docs/kanban/intake-completed.md` | Migrated and legacy file removed | DONE in `v0.4.19.5+7` |
| `docs/kanban/fbu-uxr-structure.md` | `docs/kanban/intake-structure.md` | Migrated; legacy retained as compatibility-alias stub | DONE; alias retained |
| `docs/kanban/fbu-uxr-board.md` | `docs/kanban/kboard.md` | Alias-only stub retained for compatibility; canonical board remains `kboard.md` | DONE in `E4:S19:T06` Wave 2 |
| `docs/kanban/fbu-uxr-open-taskless-queue.md` | `docs/kanban/intake-open-taskless-queue.md` | Canonical queue file created and legacy filename converted to alias-only stub | DONE in `E4:S19:T06` Wave 2 |
| `docs/kanban/fbu/` directory | `docs/kanban/fbu/` *(decision pending)* | High-blast-radius rename; deferred pending impact analysis | DEFERRED — explicit retention until separately approved |
...
- Renamed supporting files leave a legacy-named stub that contains only YAML frontmatter, a `Legacy Alias:` header, and a one-line redirect link to the canonical file (mirrors current `fr-br-uxr-structure.md` style — see [example](../kanban/fbu/UXR-005-kanban-board-formatting-and-governance.md)).
...
- `docs/kanban/fbu/UXR-008-kboard-fbuboard-default-naming-adoption.md`
- `docs/kanban/fbu/FR-086-canonical-supporting-kanban-fbu-doc-naming-and-fbu-collective-terminology.md`
- `docs/kanban/fbu/FR-073-fr-br-uxr-board-open-taskless-intake-execution-plan.md`
...
- [FR-073](../kanban/fbu/FR-073-fr-br-uxr-board-open-taskless-intake-execution-plan.md)
