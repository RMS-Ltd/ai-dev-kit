...
| Step | Action | Deliverable |
|------|--------|-------------|
| 3.1 | Update [`INSTALL_IN_YOUR_PROJECT.md`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md) greenfield chapter; cross-link **ADR-003**, **FR-081**. | Meets **AC3** / **F5**. |
...
- [x] Bidirectional wiring: this IPW ↔ host task remain linked ([T01](../kanban/epics/epic-06/story-09-ai-dev-kit-installation-and-adopter-integration/T01-greenfield-installation-process-fr080.md)).
