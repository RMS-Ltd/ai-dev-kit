...
**Planning for:** [FR-085 — UKW optional reprioritization (`--rp`)](../kanban/fbu/FR-085-ukw-optional-reprioritization-rp-flag.md)  
**Status:** Published
...
| RNF2 | No batch or synthetic `Last modified` row stamps on hygiene ([FR-097](../kanban/fbu/FR-097-board-stamp-authority-and-forensic-timestamp-recovery.md)) | FR-097 |
...
- **vs `rw_step_7`:** Agents MUST NOT invoke `--rp` during RW Step 7 ([FR-038](../kanban/fbu/FR-038-rw-step-7-scoped-kanban-sync-ukw-mode.md) narrow MoSCOW).
...
| D-U9 | `docs/kanban/fbu/FR-085-*.md` | IMPLEMENTED at RW | RF6 |
