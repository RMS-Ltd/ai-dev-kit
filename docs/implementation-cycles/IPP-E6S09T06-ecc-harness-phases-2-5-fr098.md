...
**Status:** Phases 2–5 **delivered** — host task **COMPLETE** (**v0.6.9.6+3**); FR-098 **IMPLEMENTED**. **Wave E** (public-repo ECC validation) **planned** — blocked on [FR-099](../kanban/fbu/FR-099-spin-off-book-epic-to-private-repository.md) Phase 3.
...
| RF10 | **Real-world validation** on public ADK repo after [FR-099](../kanban/fbu/FR-099-spin-off-book-epic-to-private-repository.md) Phase 3: greenfield install, then cheatsheet §3 (including optional `--execute`) | Wave E, maintainer plan 2026-05-26 |
...
| 12 | **Wave E — prerequisite:** [FR-099](../kanban/fbu/FR-099-spin-off-book-epic-to-private-repository.md) **E1:S04:T06** (public rebirth) + **E1:S04:T07** (rewire + install smoke) | Public clone ready |
...
- `docs/kanban/fbu/FR-098-ecc-optional-harness-layer-integration.md` (F5/F6 status)
...
| D-U7 | `docs/kanban/fbu/FR-098-*.md` | F5/F6 checkboxes when waves land | RF1, RF7 |
...
- [FR-099 — Public repo spin-off](../kanban/fbu/FR-099-spin-off-book-epic-to-private-repository.md)
