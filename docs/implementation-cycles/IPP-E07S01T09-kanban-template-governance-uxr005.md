...
**Outcome:** `EXEMPT` — governing docs: [kanban-board-guide.md](../project-management/kanban/kanban-board-guide.md) § Formatting Governance, [UXR-005](../project-management/kanban/fr-br/UXR-005-kanban-board-formatting-and-governance.md)
