...
1. Kept task-doc wording updates for non-timestamped repeating tail segments in:
   - `docs/kanban/epics/epic-02/story-15-ipw-governance-and-publication-contract/T05-implement-ukw-rw-canonical-row-transform-engine-fr090.md`
...
2. `docs/kanban/epics/epic-02/story-15-ipw-governance-and-publication-contract/T05-implement-ukw-rw-canonical-row-transform-engine-fr090.md`
...
7. `docs/kanban/kboard.md`
8. `docs/kanban/kboard.md`
9. `docs/kanban/epics/epic-02/story-16-perpetual-ongoing-workflow-operations/T04-ad-hoc-kanban-synchronization-and-hygiene-perpetual.md`
10. `rw-config.yaml`
