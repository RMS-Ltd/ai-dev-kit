...
**Planning for:** [FR-045](../kanban/fbu/FR-045-adr-002-task-touch-derived-mapping.md) · [FR-046](../kanban/fbu/FR-046-rw-semver-tag-task-touch-mode.md) · [BR-061](../kanban/fbu/BR-061-semver-task-touch-counter-increments-too-often.md)  
...
- [FR-077 — IPW status transition and kboard sync](../kanban/fbu/FR-077-ipw-built-task-status-transition-and-kboard-sync.md)
