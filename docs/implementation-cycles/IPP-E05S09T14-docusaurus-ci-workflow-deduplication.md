...
| D-U6 | `docs/project-management/kanban/fr-br/BR-093-*.md` | Status update on verification | Step 7 |
...
- [T14 — Docusaurus CI workflow deduplication (BR-093)](../project-management/kanban/epics/epic-05/story-09-docusaurus-documentation-portal/T14-docusaurus-ci-workflow-deduplication-br093.md)
- [BR-093 — Docusaurus CI duplicate build + deploy job waste](../project-management/kanban/fr-br/BR-093-docusaurus-ci-duplicate-build-deploy-job-waste.md)
