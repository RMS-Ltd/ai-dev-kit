...
- Automated tests: [`tests/test_install_release_workflow_patterns.py`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/tests/test_install_release_workflow_patterns.py) — placeholder detection and preview glob matching.
