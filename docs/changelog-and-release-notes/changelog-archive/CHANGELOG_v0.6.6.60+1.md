...
- `packages/frameworks/workflow mgt/scripts/validation/validate_version_bump.py` — task doc discovery by **`Task ID`** header when story pattern collides (e.g. multiple `story-06-*`).
...
- `validate_version_bump.py` — locates T60 under `story-06-feature-requests/`.
