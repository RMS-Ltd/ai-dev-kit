# Changelog v0.5.1.37+1

**Release Date:** 2026-02-08 16:16:14 UTC
...
Created repository task E5:S01:T37 for FR-037 (Kanban Policy – Task Prioritisation and Queue/Stack). Task document and FR assignment added; FR-037 is now wired to E5:S01:T37. Implementation (governance policy and board guide updates) will be performed when assigned by intake.
...
- **FR-037** – Kanban Policy Task Prioritisation and Queue/Stack
  - Feature request proposes adding task prioritisation and MUST HAVE queue/stack rules to framework Kanban governance policy (source: Starborn Legacy)
