# Changelog v0.4.19.6+1

**Release Date:** 2026-04-26 12:55:00 UTC  
**Internal Version:** 0.4.19.6+1  
**Epic / Story / Task:** E4 | S19 | T06

## Summary

`RW E4S19T06 --art` publishes the new meta ownership anchor for UXR-008, FR-086, and FR-073 by filing `E4:S19:T06`, wiring a canonical IPP artifact, superseding fragmented task ownership (T02/T05), and updating board/FBU traceability surfaces to the consolidated governance path.

## Changes

- Added meta task: `E4:S19:T06` (`T06-fbu-meta-normalization-and-intake-governance-uxr008-fr086-fr073.md`)
- Added meta planning artifact: `IPP-E4S19T06-fbu-meta-normalization-and-intake-governance.md`
