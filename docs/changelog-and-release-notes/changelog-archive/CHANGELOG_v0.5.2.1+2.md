...
```bash
# Validate links
python3 scripts/documentation/validate-documentation-links.py --path docs/

# Validate consistency
python3 scripts/documentation/validate-documentation-consistency.py --path docs/ --check all
```
