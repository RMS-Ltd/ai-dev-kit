...
- Evidence:
  ...
  - `paths_checked`: `0`
  - `violations`: `0`
  - `release_scope`: `{'task_doc': {'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-05/story-09-docusaurus-documentation-portal/T14-docusaurus-ci-workflow-deduplication-br093.md'], 'notes': ['Version anchor v0.5.9.14+3; COMPLETE retained']}, 'fbu_doc': {'touched': True, 'paths': ['docs/project-management/kanban/fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md', 'docs/project-management/kanban/fr-br/BR-093-docusaurus-ci-duplicate-build-deploy-job-waste.md'], 'notes': ['BR-067 policy table: tagged-BUILD guard; BR-093 remains FIXED']}, 'kboard': {'touched': True, 'paths': ['docs/project-management/kanban/kboard.md'], 'notes': ['Board metadata v0.5.9.14+3; V-band row already pruned at +2 wave']}, 'fbuboard': {'touched': False, 'paths': [], 'notes': ['ADR-018 redirect stub — no active MoSCOW maintenance on fbuboard']}, 'story_doc': {'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-05/story-09-docusaurus-documentation-portal.md']}, 'planning_artifact': {'touched': True, 'paths': ['docs/implementation-cycles/IPP-E05S09T14-docusaurus-ci-workflow-deduplication.md']}}`
