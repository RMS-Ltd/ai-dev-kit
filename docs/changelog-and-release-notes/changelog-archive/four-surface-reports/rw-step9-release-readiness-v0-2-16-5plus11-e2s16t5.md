...
- **Release scope:** E02:S16:T05 (v0.2.16.5+11)
- **Timestamp (UTC):** 2026-06-15 20:45 UTC
- **Four-surface report:** `/Users/ruari/Projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-2-16-5plus11-e2s16t5.json`
...
- Evidence:
  - `four_surface_report`: `/Users/ruari/Projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-2-16-5plus11-e2s16t5.json`
  - `paths_checked`: `3`
  - `violations`: `0`
  - `release_scope`: `{'epic': 2, 'story': 16, 'task': 5, 'task_id': 'E02:S16:T05', 'version_string': 'v0.2.16.5+11', 'art_adopted': True, 'docs_only': True}`
...
- Evidence:
  - `report`: `/Users/ruari/Projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-2-16-5plus11-e2s16t5.json`
  - `evidence_mode`: `None`
...
- Evidence:
  - `report`: `/Users/ruari/Projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-2-16-5plus11-e2s16t5.json`
  - `task_doc`: `{'touched': True, 'paths': ['docs/kanban/epics/epic-02/story-16-perpetual-ongoing-workflow-operations/T05-github-actions-ci-health-perpetual.md'], 'notes_count': 0}`
  - `fbu_doc`: `{'touched': True, 'paths': ['docs/kanban/fr-br/BR-104-codeql-cqg-green-does-not-imply-actions-ci-green.md'], 'notes_count': 0}`
