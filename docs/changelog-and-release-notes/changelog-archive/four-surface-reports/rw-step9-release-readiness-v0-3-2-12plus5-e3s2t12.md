...
- **Release scope:** E3:S2:T12 (v0.3.2.12+5)
- **Timestamp (UTC):** 2026-06-05 02:04 UTC
- **Four-surface report:** `/Users/rms/Documents/projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-3-2-12plus5-e03s02t12.json`
...
- Evidence:
  ...
  - `stamp_evidence_aggregate`: `{'stamps_appended_with_evidence': 0, 'stamps_skipped_no_evidence': 0, 'stamps_preserved_existing': 46}`
...
- Evidence:
  - `four_surface_report`: `/Users/rms/Documents/projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-3-2-12plus5-e03s02t12.json`
  - `paths_checked`: `7`
  - `violations`: `0`
  - `release_scope`: `{'epic': 3, 'story': 2, 'task': 12, 'task_id': 'E3:S2:T12', 'version_string': 'v0.3.2.12+5'}`
...
- Evidence:
  - `report`: `/Users/rms/Documents/projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-3-2-12plus5-e03s02t12.json`
  - `evidence_mode`: `None`
...
- Evidence:
  - `report`: `/Users/rms/Documents/projects/ai-dev-kit/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-3-2-12plus5-e03s02t12.json`
  - `task_doc`: `{'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-03/story-02-versioning-cookbook-and-examples/T12-implement-task-touch-semver-mapping-mode.md'], 'notes_count': 0}`
  - `fbu_doc`: `{'touched': True, 'paths': ['docs/project-management/kanban/fr-br/FR-045-adr-002-task-touch-derived-mapping.md', 'docs/project-management/kanban/fr-br/FR-046-rw-semver-tag-task-touch-mode.md', 'docs/project-management/kanban/fr-br/BR-061-semver-task-touch-counter-increments-too-often.md'], 'notes_count': 0}`
