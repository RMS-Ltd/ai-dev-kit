...
- Evidence:
  ...
  - `paths_checked`: `0`
  - `violations`: `0`
  - `release_scope`: `{'task_doc': {'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-02/story-01-rw-agent-execution-and-docs/T24-rw-build-increment-enforcement-and-tag-immutability-br097.md'], 'notes': ['Kanban-init intake v0.2.1.24+0']}, 'fbu_doc': {'touched': True, 'paths': ['docs/project-management/kanban/fr-br/BR-097-rw-agent-reuses-tagged-build-and-force-moves-release-tags.md'], 'notes': ['BR-097 wired to E02:S01:T24; prior-work failure analysis']}, 'kboard': {'touched': True, 'paths': ['docs/project-management/kanban/kboard.md'], 'notes': ['S-band row E02:S01:T24']}, 'fbuboard': {'touched': False, 'paths': [], 'notes': ['ADR-018 redirect stub — intake on kboard only']}, 'story_doc': {'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-02/story-01-rw-agent-execution-and-docs.md']}}`
