...
- **Release scope:** E21:S09:T03 (v0.21.9.3+1)
- **Timestamp (UTC):** 2026-06-08 14:48 UTC
- **Four-surface report:** `/Users/rms/Documents/projects/ai-dev-kit-e21/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-21-9-3plus1-e21s9t3.json`
...
- Evidence:
  - `/Users/rms/Documents/projects/ai-dev-kit-e21/docs/kanban/kboard.md`: `{'rows_changed': 0, 'rows_with_duplicate_footers': 0}`
  - `stamp_evidence_aggregate`: `{'stamps_appended_with_evidence': 0, 'stamps_skipped_no_evidence': 0, 'stamps_preserved_existing': 26}`
...
- Evidence:
  - `four_surface_report`: `/Users/rms/Documents/projects/ai-dev-kit-e21/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-21-9-3plus1-e21s9t3.json`
  - `paths_checked`: `6`
  - `violations`: `0`
  - `release_scope`: `{'epic': 21, 'story': 9, 'task': 3, 'task_id': 'E21:S09:T03', 'version_string': 'v0.21.9.3+1'}`
...
- Evidence:
  - `report`: `/Users/rms/Documents/projects/ai-dev-kit-e21/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-21-9-3plus1-e21s9t3.json`
  - `evidence_mode`: `None`
...
- Evidence:
  - `report`: `/Users/rms/Documents/projects/ai-dev-kit-e21/docs/changelog-and-release-notes/changelog-archive/four-surface-reports/rw-step7-four-surface-report-v0-21-9-3plus1-e21s9t3.json`
  - `task_doc`: `{'touched': True, 'paths': ['/Users/rms/Documents/projects/ai-dev-kit-e21/docs/kanban/epics/epic-21/story-09-epic-housekeeping/T03-pr-merge-ci-and-adopter-public-doc-gates.md'], 'notes_count': 0}`
  - `fbu_doc`: `{'touched': False, 'paths': [], 'notes_count': 1}`
  - `kboard`: `{'touched': True, 'paths': ['/Users/rms/Documents/projects/ai-dev-kit-e21/docs/kanban/kboard.md'], 'notes_count': 0}`
  - `release_scope`: `{'epic': 21, 'story': 9, 'task': 3, 'task_id': 'E21:S09:T03', 'version_string': 'v0.21.9.3+1'}`
