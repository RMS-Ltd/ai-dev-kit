...
- Evidence:
  ...
  - `paths_checked`: `0`
  - `violations`: `0`
  - `release_scope`: `{'task_doc': {'touched': True, 'paths': ['docs/project-management/kanban/epics/epic-04/story-06-comprehensive-canonical-est-template-system/T06-br005-canonical-epics-structure-gap.md']}, 'fbu_doc': {'touched': True, 'paths': ['docs/project-management/kanban/fr-br/BR-005-kanban-framework-epic-structure-gap-uat-finding.md']}, 'kboard': {'touched': True, 'paths': ['docs/project-management/kanban/kboard.md'], 'action': 'prune_c_band_row_E04S06T06'}, 'kanban_completed': {'touched': True, 'paths': ['docs/project-management/kanban/kanban-completed.md']}, 'intake_structure': {'touched': True, 'paths': ['docs/project-management/kanban/intake-structure.md']}, 'planning_artifact': {'touched': True, 'paths': ['docs/implementation-cycles/IPP-E04S06T06-br005-canonical-epics-structure-gap.md']}}`
