# Changelog v0.6.9.7+1

**Release Date:** 2026-06-03 17:40:56 UTC  
**Epic | Story | Task:** E06:S09:T07 (`RW -k --art`)  
**SemVer (task_touch):** v0.4.854+1  

## Summary

**Kanban init (RW -k):** Intake **BR-078** from GitHub [#10](https://github.com/RMS-Ltd/ai-dev-kit/issues/10) — fresh kanban install reports `KANBAN_STRUCTURE_TEMPLATE.md` not found. Task **E06:S09:T07** filed; **fbuboard** / **kboard** Should Have wiring; story **E06:S09** reopened.
