...
IPP **E02:S16:T03** Tranche 3 — BR-067 **RESOLVED** (R1–R5 regression PASS), active kanban link hygiene (15 files: `epic-06/story-007` → story-016 T03/T04), IPP §2.5/§4.4/§5–§7 Tranche 3. AC4 remains PARTIAL until T02 (3B deferred).
...
- **Link hygiene** — FR/BR/epic kanban paths corrected to `epic-02/story-16-perpetual-ongoing-workflow-operations/` (UKW → T04, umbrella → T03).
