...
**RW -k E6:S07:T109:** Discrete task for **BR-059** (UKW must enumerate all open story tasks on MoSCOW); template fields; **epic/6** version/changelog/board markers.

## Verification

- `validate_branch_context.py --strict`; RW task validators **`--mode rw-k`** for **E6:S07:T109**.
