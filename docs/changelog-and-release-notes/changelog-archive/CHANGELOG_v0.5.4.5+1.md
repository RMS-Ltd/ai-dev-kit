...
- Created `docs/documentation/user-docs/framework-dependency-installation-guide.md`
...
- `docs/documentation/user-docs/framework-dependency-installation-guide.md` (new - Installation guide)
