...
[Detailed changelog](CHANGELOG_v0.2.16.3+7.md)
...
[Detailed changelog](CHANGELOG_v0.2.16.10+7.md)
...
[Detailed changelog](CHANGELOG_v0.2.16.4+41.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.1.2.14+1.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.2.13.6+1.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.2.14.1+1.md)
...
---
---
## [0.2.16.21+2] - 05-06-26

E02:S16:T21 — **Change implemented:** UXR-024 intake doc relative link path fixes. SemVer **v0.4.987+2**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.2.16.21+2.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.9.23+1.md)
...
E06:S09:T23 — **Post-ship CI fix:** greenfield-install epic template casing aligned for Linux drift check; `greenfield-release.yml` tag filter corrected for GHCR publish. SemVer **v0.4.959+3**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.9.23+3.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.9.23+4.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.9.24+1.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.12+1.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.12+4.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.12+8.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.13+0.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.14+2.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.14+3.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.14+5.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.16+1.md)
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.8.3.17+4.md)
...
[Detailed changelog](CHANGELOG_v0.6.9.9+2.md)
---
## [0.2.16.3+3] - 03-06-26
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.1.4.7+1.md)
---
## [0.1.4.6+1] - 26-05-26

E1:S04:T06 (`RW -k`, `--art`) — Kanban init: FR-099 Phase 3 — Public ai-dev-kit rebirth. SemVer **v0.4.811+1**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.1.4.6+1.md)
---
## [0.1.4.5+1] - 26-05-26

E1:S04:T05 (`RW -k`, `--art`) — Kanban init: FR-099 Phase 2 — Book extraction genesis. SemVer **v0.4.811+1**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.1.4.5+1.md)
---
## [0.1.4.4+1] - 26-05-26
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.2.16.4+5.md)
---
## [0.6.1.38+1] - 12-05-26

E6:S01:T38 — **`RW`** with **`--art`**: implements BR-072 fix — UKW Step 6 restructured into Part A (remove completed tasks, archive to `kanban-completed.md`, deduplication guard) and Part B (MoSCOW classification of active tasks only). All three UKW definition files updated consistently. IPP published.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.1.38+1.md)
---
## [0.6.1.38+0] - 12-05-26

E6:S01:T38 — **`RW -k`** with **`--art`**: kanban-init intake of BR-072 (UKW not removing completed tasks from kboard). Files BR, creates investigation task, wires bidirectional traceability, and establishes known test fixtures as reproducible artefacts. Also publishes the 11-agent single-purpose workflow agent PoC (agents/ directory).

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.1.38+0.md)
---
## [0.2.15.7+1] - 27-04-26
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.4.19.4+1.md)
---
## [0.2.15.2+3] - 20-04-26
...
---
## [0.6.7.115+1] - 20-04-26

E6:S07:T115 — **RW** with **`--art`**: filed and housed UXR-009 plus ICW package for timestamp forensic-integrity guardrails (`Last modified` must reflect substantive work, not board rewrites). SemVer **v0.4.758+1**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.7.115+1.md)
---
## [0.6.7.115+2] - 20-04-26
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.9.11+5.md)
---
## [0.5.9.11+4] - 19-04-26

E5:S09:T11 — **RW** with **`--art`**: Wave 3 verification (**TD1–TD3**) + evidence. SemVer **v0.4.757+4**.
...
[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.9.1+4.md)
---
## [0.6.9.1+3] - 19-04-26
...
**Full changelog:** [`docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+16.md`](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+16.md)
...
**Full changelog:** [`docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+17.md`](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+17.md)
...
**Related:** [Detailed Changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+18.md)
...
**Related:** [Detailed Changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+19.md)
...
**Related:** [Detailed Changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.6+20.md)
...
📚 Documentation: E6:S06:T56 – BR-056 RW Ambiguous Task Identifier Typo Risk (task filed). RW accepts user-supplied task identifiers without validation; single-digit typo causes wrong attribution.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.6.56+1.md)
