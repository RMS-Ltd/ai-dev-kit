# Changelog v0.2.16.12+1

**Release Date:** 2026-05-26 12:44:48 UTC  
**Epic:** 2 | **Story:** 16 | **Task:** 12  
**Task:** E2:S16:T12 — IPW ADR necessity checklist and decision gate (FR-100 intake)

---

## Summary

**Kanban documentation setup (RW -k):** Filed **FR-100** and **E2:S16:T12** with atomic bidirectional wiring; updated Story 016 checklist, Epic 2 summary, **kboard**, and **fbuboard**. Defines hybrid measurable ADR decision criteria (T1–T7 triggers, E1–E5 exemptions) for a follow-on IPW implementation pass. Adopted via **`--art`** from E6:S09:T05.
