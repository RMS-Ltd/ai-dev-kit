...
- **Directory Structure:** `docs/kanban/Epic X/` (with space, not hyphen)
...
- Structure: `docs/kanban/Epic X/Story-X.md`
...
**Kanban Files:**
- `docs/kanban/Epic X/` (Epics 1-22, with space in directory name)
