...
**ADK pin:** `v0.4.1063` (release tarball) · **Project:** Starborn Legacy (`starborn_legacy`)
...
| F7 | Kanban fresh + sign-off ALL READY | — | **RECORD** | Positive signal (BR-083–086, UXR-017) |
...
| F7 | Phase 6 | `signoff-report.json` ALL READY |
| F8 | Phase 8 | Legacy `KB/PM_and_Portfolio/` retained; ADK kanban exercise only |

---

## Adopter decision (not upstream defects)

Starborn Legacy **closed** the install attempt without adopting ADK template kanban. RW scaffold may be reused in a future brownfield pass per [FR-081](../../../kanban/fr-br/FR-081-brownfield-modular-adopter-integration.md). This does not block upstream greenfield installer fixes.
