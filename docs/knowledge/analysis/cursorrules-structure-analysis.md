...
**Reference:** See `docs/architecture/standards-and-adrs/doc-lifecycle-configuration.md` for complete configuration and classification rules.
```
...
3. **Update Kanban paths** (currently shows `docs/kanban/...` as templates)
