> **Architecture mirror (dev-kit navigation):** Canonical SoT is `packages/frameworks/doc-lifecycle/policies/doc-lifecycle-policy.md`. Edit the package copy first; sync this mirror for repo navigation. Maintainer checklist: [`adr-dual-sot-parity.md`](../../packages/frameworks/doc-lifecycle/docs/adr-dual-sot-parity.md). Decision record: [ADR-023](ADR-023-doc-lifecycle-package-architecture-dual-sot.md).
...
**Scope:**
- All documents in `docs/` directory tree
...
**Housekeeping:** Archived to `docs/Archive/` after expiration.
