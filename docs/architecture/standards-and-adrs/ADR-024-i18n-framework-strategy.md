...
| **E21:S03:T06** | Completeness metrics (script-first): `report_locale_completeness.py`; registry scope from [translatable-content-registry.yaml](../../governance/standards/translatable-content-registry.yaml); tier breakdown per [locale-rollout-matrix.md](../../governance/standards/locale-rollout-matrix.md). Guide: [translation-management-tools.md](../../documentation/user-docs/translation-management-tools.md) |
