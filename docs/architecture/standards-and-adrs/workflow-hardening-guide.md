...
- Prefer a **small, stable set of tools** for RW:
  ...
  - Progress tracking: [Workflow Step Tracker Contract](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/packages/frameworks/workflow-mgt/KB/Documentation/Developer_Docs/vwmp/workflow-step-tracker-contract.md) (Cursor `todo_write` or Windsurf `todo_list` adapter).
...
- **Progress tracking:**  
  - [Workflow Step Tracker Contract](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/packages/frameworks/workflow-mgt/KB/Documentation/Developer_Docs/vwmp/workflow-step-tracker-contract.md) for RW steps (not Cursor-specific).
