...
**Location:** `docs/architecture/standards-and-adrs/agent-network-access-and-git-push-limitations.md`
...
- **Pros:** No network on every RW; operator batches pushes; reduces GitHub load ([UXR-024](../../kanban/fr-br/UXR-024-rw-local-release-default-no-push-batch-operator-push.md))
