...
- **Pros:** No network on every RW; operator batches pushes; reduces GitHub load ([UXR-024](../../kanban/fbu/UXR-024-rw-local-release-default-no-push-batch-operator-push.md))
