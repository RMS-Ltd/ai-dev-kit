...
**Related:** [FR-103](../../kanban/fbu/FR-103-agent-bootstrap-and-task-routing.md), `README.md`, `AGENTS.md`, `docs/project-agent-manifest.json`, `docs/project-agent-index.md`
...
- [FR-022](../../kanban/fbu/FR-022-policy-docs-machine-readable-salience.md) — `protocol[]` pointers complement policy salience work
