...
2. **Bump Version** - **MANDATORY STEP-BY-STEP PROCESS (DO NOT SKIP ANY STEP):**
   ...
   **B. IDENTIFY COMPLETED TASK (MANDATORY):**
   - Read the Story file: `docs/kanban/epics/Epic-{epic}/stories/Story-{story}-*.md`
...
- **[Version File (source)](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/src/fynd_deals/version.py)** - Current version implementation
