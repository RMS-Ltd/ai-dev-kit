...
**Planning:** [IPP-E02S01T30](../../implementation-cycles/IPP-E02S01T30-rw-architectural-contract-release-transaction.md) · [FR-122](../../kanban/fr-br/FR-122-release-workflow-architectural-contract-release-transaction.md)

---

## Context

The Release Workflow (RW) evolved from an 11-step fynd.deals extract into a 13-step intelligent agent workflow with 30+ reactive gates ([FR-060](../../kanban/fr-br/FR-060-rw-task-argument-requirement.md), [BR-097](../../kanban/fr-br/BR-097-rw-agent-reuses-tagged-build-and-force-moves-release-tags.md), [FR-092](../../kanban/fr-br/FR-092-canonical-rw-ukw-kanban-consistency-program.md), [FR-112](../../kanban/fr-br/FR-112-perpetual-github-ci-and-security-health-lanes.md), [FR-120](../../kanban/fr-br/FR-120-semver-allocation-authority-transactional-mapping-black-box.md)) without an initial architectural IPW. Requirements live in `.cursorrules`, a 3k-line execution guide, `canonical-rw-steps.yaml`, and per-incident validators.
...
4. **I4 — Stage parity:** Staged set ⊇ four-surface touched paths ([BR-070](../../kanban/fr-br/BR-070-rw-k-stage-files-completeness-gap-allows-partial-kanban-commit.md)).
...
| **C — Hybrid (chosen)** | Agent owns MUTATE; scripts own integrity surfaces; incremental waves per [FR-122](../../kanban/fr-br/FR-122-release-workflow-architectural-contract-release-transaction.md) |
...
- [FR-092](../../kanban/fr-br/FR-092-canonical-rw-ukw-kanban-consistency-program.md) — Kanban four-surface atomicity (MUTATE/VALIDATE slice)
