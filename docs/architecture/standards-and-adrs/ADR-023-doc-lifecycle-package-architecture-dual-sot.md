...
[T04 integration alignment](../../project-management/kanban/epics/epic-10/story-01-document-lifecycle-package-implementation-review/integration-alignment-report.md) scored Domain 5 **PARTIAL** (link drift) and Domain 7 **GAP** (salience schema not packaged). [FR-110](../../project-management/kanban/fr-br/FR-110-lean-adopter-distribution-footprint-and-vendor-bundle.md) requires the canonical package tree to byte-sync to `greenfield-install/packages/frameworks/doc-lifecycle/`.
