...
- [x] **AC4:** ADK workflow skills (`adk-release-workflow` + full Phase 1 target set) exist in ECC-compatible format — **COMPLETE** (**v0.6.9.5+2**).
...
- Story: [`docs/kanban/epics/epic-06/story-09-ai-dev-kit-installation-and-adopter-integration.md`](../epics/epic-06/story-09-ai-dev-kit-installation-and-adopter-integration.md)
