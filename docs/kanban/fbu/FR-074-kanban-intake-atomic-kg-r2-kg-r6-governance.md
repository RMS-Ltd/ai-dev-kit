...
Orphan `fbu/*.md` files and inconsistent intake order produced board drift and validator pain. Strict 1:1 id symmetry forced tasks into repository semantics instead of delivery stories.
...
- **FR-074:R06** — **`kboard.md`** + **T73** story-choice / hygiene pointers.
