...
- Representative MDX errors (paraphrased from compiler output):
  ...
  - Unresolved **`https://github.com/RMS-Ltd/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md`** from e.g. `docs/documentation/user-docs/*.md`, `docs/architecture/standards-and-adrs/ADR-003-*.md`, `docs/kanban/fbu/FR-080-*.md`.  
