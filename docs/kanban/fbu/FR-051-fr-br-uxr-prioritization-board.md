...
2. **Completed Board (`intake-completed.md`)**
...
1. `docs/kanban/kboard.md` - Main prioritization board
2. `docs/kanban/intake-completed.md` - Completed items tracking
...
- **FR/BR/UXR Documents** - Link to individual documents in `/fbu/` directory
...
- Existing FR/BR/UXR documents in `/fbu/` directory
