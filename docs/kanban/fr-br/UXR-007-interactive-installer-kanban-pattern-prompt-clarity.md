...
1. `Kanban root directory [docs/kanban]: KB/PM_and_Portfolio/epics/overview`
...
3. **Kanban framework installer validated a different root**
   ...
   - `install_kanban_framework.py --mode fresh` validated default path `docs/kanban` and failed with:
