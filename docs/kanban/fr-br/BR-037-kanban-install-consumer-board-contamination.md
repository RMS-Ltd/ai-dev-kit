...
1. **Fresh installs** of the Kanban framework:
   - Produce a **clean, project-agnostic** Kanban tree rooted at `docs/kanban/`.
...
- **Contamination detection**:
  - A dedicated contamination detector walks `docs/kanban/` and:
...
- Dev-kit FR/BR repo structure (`docs/kanban/fr-br/FR-0xx-*.md`) inside consumer trees.
...
2. **Run the contamination detector** over `docs/kanban/`.
