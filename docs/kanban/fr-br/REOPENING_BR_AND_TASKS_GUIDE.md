...
See [`docs/kanban/epics/epic-02/story-01-rw-agent-execution-and-docs.md`](../epics/epic-02/story-01-rw-agent-execution-and-docs.md) Task T06 for an example of:
...
- `docs/kanban/fr-br/BR-002-changelog-validator-ordering-bug.md` - Example reopened BR
- `docs/kanban/epics/epic-02/story-01-rw-agent-execution-and-docs.md` - Example reopened task
