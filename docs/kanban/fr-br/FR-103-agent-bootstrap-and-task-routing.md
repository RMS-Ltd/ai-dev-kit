...
| Kanban / intake | `FR`, `BR`, `UXR`, `intake`, `kboard` | `docs/kanban/kboard.md`, intake guide (pointers) |
...
- Splitting `AGENTS.md` may require moving current role definitions to `docs/kanban/AGENTS.md` (already exists) or a dedicated `docs/agents/` index — IPP should decide housing.
