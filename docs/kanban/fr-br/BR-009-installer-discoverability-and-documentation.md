...
3. **Manual Copying Problem:** Users manually copy `docs/kanban/epics/*` and get ai-dev-kit's project-specific content
...
**Actual Behavior:**
- Users manually copy files: `cp -r packages/frameworks/ai-dev-kit/docs/kanban/epics/* docs/kanban/epics/`
...
4. Manually copy Kanban structure: `cp -r packages/frameworks/ai-dev-kit/docs/kanban/epics/* docs/kanban/epics/`
...
- **GitHub Issue:** #14
- **BR-004:** `docs/kanban/fr-br/BR-004-kanban-installation-includes-project-specific-epics.md`
