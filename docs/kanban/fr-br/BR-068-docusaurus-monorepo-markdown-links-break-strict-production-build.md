...
- Representative MDX errors (paraphrased from compiler output):
  ...
  - Unresolved **`https://github.com/RMS-Ltd/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md`** from e.g. `docs/documentation/user-docs/*.md`, `docs/architecture/standards-and-adrs/ADR-003-*.md`, `docs/kanban/fr-br/FR-080-*.md`.  
...
| Area | Role |
|------|------|
| [`portal/docusaurus.config.js`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/portal/docusaurus.config.js) | Docs path, `exclude`, strict hooks |
| [`portal/sidebars.js`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/portal/sidebars.js) | Autogenerated sections only — no fix without link/corpus strategy |
| Repository `docs/**/*.md` | Many relative links to root / `packages/` |
| Root [`INSTALL_IN_YOUR_PROJECT.md`](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md) | Canonical adopter entry **outside** `docs/` |
