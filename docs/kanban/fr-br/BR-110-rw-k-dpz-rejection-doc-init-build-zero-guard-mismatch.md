...
**Status:** TODO  
**Observed Version Outcome:** resolver chooses **BUILD +1** (`0.8.3.23+1`)
...
- That tagged commit includes first-intake artifacts for this anchor:
  - adds `docs/kanban/fr-br/BR-109-greenfield-autofix-dual-tree-sync-drift-recurring-ci-failures.md`
