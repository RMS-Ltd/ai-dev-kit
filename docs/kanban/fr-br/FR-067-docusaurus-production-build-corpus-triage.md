...
**Implementing Task:** [E05:S09:T03](../epics/epic-05/story-09-docusaurus-documentation-portal/T03-docusaurus-build-triage-fr-067.md)
**Assigned Task:** E05:S09:T03 — [`T03-docusaurus-build-triage-fr-067.md`](../epics/epic-05/story-09-docusaurus-documentation-portal/T03-docusaurus-build-triage-fr-067.md)
...
|----|---------|---------|------------|
| **FU-1** | ~~Restore **strict** broken-link checking (`onBrokenLinks` / `onBrokenMarkdownLinks` → **`throw`**)~~ **DONE** | Shipped with **E05:S09:T08** after corpus link remediation; build fails on broken in-scope links. Ongoing hygiene: [FR-058](FR-058-markdown-maintenance-workflow.md). | **Task (complete):** [E05:S09:T08](../epics/epic-05/story-09-docusaurus-documentation-portal/T08-docusaurus-strict-broken-links-post-fr067.md). |
| **FU-2** | **GitHub Release** page for published **SemVer** tags | Tags reach GitHub on push; the **Releases** UI entry is created/updated only when RW **Step 12.5** runs (token present). Same version stream as all RW releases—not a portal-only concern. | **Task (SoT):** [E02:S16:T03](../epics/epic-02/story-16-perpetual-ongoing-workflow-operations/T03-rehouse-workflow-perpetual-tasks-and-harden-guardrails.md). **FR:** [FR-041](FR-041-perpetual-task-for-release-workflow-maintenance.md). **Mechanism:** [RW Step 12.5](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/.cursorrules); [`create_github_release.py` (source)](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/packages/frameworks/workflow-mgt/scripts/create_github_release.py). |
| **FU-3** | ~~**Strict broken-anchor checking** (`onBrokenAnchors` → **`throw`**)~~ **DONE** | Shipped with **E05:S09:T10** at **`v0.5.9.10+2`**: corpus anchor/heading alignment, `onBrokenAnchors: 'throw'`, README + pytest; CI **`npm run build`** fails on bad `#fragment` links. | **Task (complete):** [E05:S09:T10](../epics/epic-05/story-09-docusaurus-documentation-portal/T10-docusaurus-strict-broken-anchors-post-t08.md). |

**Docs that echo this table:** [docusaurus corpus triage note](../../maintenance/docusaurus-corpus-triage-fr-067.md) (Deferred outcomes — **FU-1** / **FU-2** / ~~**FU-3**~~), [portal README (repository root)](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/portal/README.md) (**FU-1** / strict links / **FU-3** anchors); **FU-2** (GitHub Releases) → [E02:S16:T03](../epics/epic-02/story-16-perpetual-ongoing-workflow-operations/T03-rehouse-workflow-perpetual-tasks-and-harden-guardrails.md) / [FR-041](FR-041-perpetual-task-for-release-workflow-maintenance.md).
...
- `docs/kanban/fr-br/FR-058-markdown-maintenance-workflow.md`
