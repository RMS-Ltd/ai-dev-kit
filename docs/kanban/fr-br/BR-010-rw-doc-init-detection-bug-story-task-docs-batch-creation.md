...
- `docs/kanban/epics/epic-04/story-13-kanban-board-moscow-prioritized-task-view/T04-assess-system-impacts.md` (task doc)
...
- Story: [`docs/kanban/epics/epic-04/story-13-kanban-board-moscow-prioritized-task-view.md`](../epics/epic-04/story-13-kanban-board-moscow-prioritized-task-view.md)
...
- `docs/kanban/epics/epic-04/story-13-kanban-board-moscow-prioritized-task-view/T04-assess-system-impacts.md` - Task document
