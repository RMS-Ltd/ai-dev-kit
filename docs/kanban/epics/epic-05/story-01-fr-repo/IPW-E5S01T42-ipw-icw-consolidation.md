...
**Planning for:** [FR-042 — Implementation Planning Workflow (IPW)](../../../fbu/FR-042-implementation-planning-workflow-ipw.md)  
...
- `docs/kanban/epics/epic-04/story-14-kanban-framework-maintenance/T01-planning-spec-tests-impl.md`
  - Add `Host Task` header link to `T01-planning-spec-tests-impl.md`.
  - Ensure host task has plan link in both `## Input` and `## References`.
- `docs/kanban/epics/epic-04/story-11-kanban-granularity-discrete-task-docs/T07-planning-spec-tests-impl.md`
...
- Inputs:
  - Scan planning artifacts in `docs/kanban/epics/**` matching `*planning*.md` and `IPW-*.md`.
- Checks:
