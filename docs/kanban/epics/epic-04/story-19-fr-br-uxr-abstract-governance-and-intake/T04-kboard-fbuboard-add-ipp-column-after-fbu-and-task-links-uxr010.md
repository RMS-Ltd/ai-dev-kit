...
# Epic 4, Story 19, Task 4: kboard add `IPP` column after FBU and task links (UXR-010)
...
- Deterministic board row contract for `kboard.md`:
...
- [x] **AC1:** `kboard.md` row format includes an `IPP` segment after FBU/task links.
