...
- Remaining supporting kanban + FR/BR/UXR docs under `docs/kanban/` still use mixed naming styles.
...
- Canonical filename policy for kanban + FR/BR/UXR related docs in `docs/kanban/`.
