...
**Task ID:** E04:S03:T01  
**Task:** E04:S03:T01 – Review existing integration documentation  
**Date:** 2025-12-02  
...
- Dev-kit uses: `docs/kanban/epics/Epic-X.md`, `docs/kanban/epics/Epic-X/stories/Story-XXX-*.md`
- **Gap:** Need dev-kit specific path examples
...
- Dev-kit uses: `docs/kanban/epics/Epic-X.md`
- **Gap:** Path structure differs (dev-kit uses consolidated `kanban/` structure)

**Story Document Paths:**
- Framework docs reference: `docs/kanban/Epic \{epic\}/Story-\{N\}-\{Name\}.md`
- Dev-kit uses: `docs/kanban/epics/Epic-X/stories/Story-XXX-*.md`
