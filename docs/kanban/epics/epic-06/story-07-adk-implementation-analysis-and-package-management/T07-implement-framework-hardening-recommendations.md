...
- Current ai-dev-kit source structure:
  - `docs/kanban/epics/epic-24/` - Epic 24 "Book Related Work" (renamed from Epic 9)
...
2. **Rename Epic 9 to Epic 24+:**
   - Rename Epic directory: `epic-09/` → `Epic-\{N\}/` (where N >= 24)
   - Rename Epic document: `epic-09.md` → `Epic-\{N\}.md`
