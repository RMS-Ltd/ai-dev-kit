...
python "packages/frameworks/workflow-mgt/scripts/kanban/sort_kanban_document_checklists.py" --document-path "docs/kanban/epics/epic-06/story-01-br-repo.md"

# Sort story checklist in epic document
python "packages/frameworks/workflow-mgt/scripts/kanban/sort_kanban_document_checklists.py" --document-path "docs/kanban/epics/epic-06/epic-06.md"
...
_This Task is part of Epic 6, Story 1: BR Repo. See [`story-01-br-repo.md`](../story-01-br-repo.md) for repository context._
