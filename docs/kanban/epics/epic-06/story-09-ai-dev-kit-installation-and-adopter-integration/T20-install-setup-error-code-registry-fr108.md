...
**Upstream:** [FR-108](../../../fbu/FR-108-install-setup-error-code-registry-and-emission.md)

**Related:** [FR-078](../../../fbu/FR-078-comprehensive-install-event-contract-logging-and-feedback-quality.md) · [FR-079](../../../fbu/FR-079-install-feedback-submission-path-and-governance.md) · [FR-080](../../../fbu/FR-080-greenfield-installation-process.md) · [UXR-016](../../../fbu/UXR-016-install-setup-interactive-feedback-external-semver-version.md) · [INSTALL_IN_YOUR_PROJECT.md](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md)
...
- [FR-108](../../../fbu/FR-108-install-setup-error-code-registry-and-emission.md) — requirements and taxonomy
...
Per [FR-083](../../../fbu/FR-083-global-ipw-gated-implementation-contract.md):
...
**FR-108:** [Install/setup error code registry and emission contract](../../../fbu/FR-108-install-setup-error-code-registry-and-emission.md)
