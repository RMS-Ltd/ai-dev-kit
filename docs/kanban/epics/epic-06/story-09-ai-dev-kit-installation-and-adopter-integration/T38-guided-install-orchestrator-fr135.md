...
- [ ] **AC2:** Arm B interactive replay documents ≤5 choice prompts; sqlite + UKW wired without hand edit. (Blocked — attempt 11 required recovery; track [BR-112](../../../fbu/BR-112-greenfield-orchestrator-install-rc-gaps.md) / [T40](T40-greenfield-orchestrator-install-rc-gaps-br112.md))
- [ ] **AC3:** Attempt 11 Phase B can substitute orchestrator for manual preflight §2–§4 (sqlite, triggers, comprehension). (Blocked — same; [T40](T40-greenfield-orchestrator-install-rc-gaps-br112.md))
...
- [ ] SBL replay evidence (attempt 11 — partial; orchestrator exit 1 → [BR-112](../../../fbu/BR-112-greenfield-orchestrator-install-rc-gaps.md) / [T40](T40-greenfield-orchestrator-install-rc-gaps-br112.md))
