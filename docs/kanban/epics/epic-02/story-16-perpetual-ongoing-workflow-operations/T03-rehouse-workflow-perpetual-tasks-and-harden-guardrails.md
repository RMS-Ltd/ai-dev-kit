...
- Implementation plan: [`IPP-E2S16T3-rehouse-workflow-perpetual-tasks.md`](../../../../implementation-cycles/IPP-E2S16T03-rehouse-workflow-perpetual-tasks.md).
...
- [x] **AC1:** `E02:S16:T03` is documented as the canonical perpetual umbrella for ad-hoc workflow maintenance not tied to a concrete delivery task. *(Wave 2/3: T03 documented as canonical perpetual umbrella with `Task Type: Perpetual Maintenance` marker; policy ratified in IPP-E2S16T1 and versioning policy §6.1.1.)*
...
- **IPP:** [IPP-E2S16T3](../../../../implementation-cycles/IPP-E2S16T03-rehouse-workflow-perpetual-tasks.md) §7 SitRep + §4.4 Step 5 (3B entry gate).
