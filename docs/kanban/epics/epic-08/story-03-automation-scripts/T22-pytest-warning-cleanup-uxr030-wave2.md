...
**Task ID:** E08:S03:T22  
**Status:** ✅ COMPLETE (v0.8.3.22+1)  
**Priority:** MEDIUM (Could Have — MoSCOW **C**)  
**Created:** 2026-06-15  
**Last updated:** 2026-06-15 (v0.8.3.22+1 – MWF delivery)  
**Version:** v0.8.3.22+1  
**Version Anchor:** v0.8.3.22+1  
**Code:** E08S03T22
...
Eliminate the dominant pytest warning noise from a green full-suite run: `datetime.utcnow()` deprecation in `cli/logging.py` and `PytestReturnNotNoneWarning` from `tests/test_rw_performance.py`.
...
3. Verify targeted pytest runs show zero warnings from these two sources.
