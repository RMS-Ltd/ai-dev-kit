...
- [x] **E08:S03:T24 – CLI package test coverage gap closure (FR-138)** — ✅ COMPLETE @ **v0.8.3.24+3** (Phase 1 **74.73%** + Phase 2 **82%**) — [Task doc](story-03-automation-scripts/T24-cli-package-test-coverage-gap-closure-fr138.md) | [FR-138](../../fr-br/FR-138-cli-package-test-coverage-gap-closure.md) | [—IPP—](../../../implementation-cycles/IPP-E08S03T24-cli-package-test-coverage-gap-closure-fr138.md)
