...
**Depth:** 3-4 levels (`docs/kanban/epics/epic-\{N\}.md`)
...
- ✅ `docs/kanban/epics/epic-01.md` (4 levels, acceptable for Kanban)
- ❌ `docs/kanban/epics/epic-01/stories/story-1/tasks/task-1.md` (7 levels, too deep)

### 5.2 Exception Rule: 4th Level Only When Justified

**When 4th Level is Acceptable:**
- Epic-specific assets: `docs/kanban/epics/epic-01/assets/`
