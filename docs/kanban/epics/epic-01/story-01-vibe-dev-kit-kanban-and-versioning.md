...
- Provide a simple, repo-local Kanban structure under `docs/kanban/`.
...
- [x] Create `docs/kanban/_index.md` with:
...
- [x] Create `docs/kanban/story-01-ai-dev-kit-kanban-and-versioning.md` (this file).
- [x] Include:
