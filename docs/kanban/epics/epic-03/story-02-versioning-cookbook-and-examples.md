...
- [ ] **E03:S02:T16 — SemVer public surface BUILD leak fix (BR-111)** - 📋 TODO (HIGH — SBL attempt 11; ADR-031 implementation gap) — [Task](story-02-versioning-cookbook-and-examples/T16-semver-public-surface-build-leak-br111.md) | [BR-111](../../fbu/BR-111-semver-public-surface-build-metadata-leak.md) | [#85](https://github.com/RMS-Ltd/ai-dev-kit/issues/85) | —No IPP—
