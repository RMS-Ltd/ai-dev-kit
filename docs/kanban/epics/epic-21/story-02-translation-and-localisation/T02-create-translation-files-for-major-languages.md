...
# Epic 21, Story 2, Task 2: Create translation files for major languages
...
```text
RW -k E21:S02:T02 --art --dpz
```

**Target version anchor:** `v0.21.2.2+0` (doc-init BUILD +0 per [BR-067](../../../fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md)).
