...
- **Epic 2:** `docs/kanban/epics/epic-02/epic-02.md` - Workflow Management Framework
- **Epic 3:** `docs/kanban/epics/epic-03/epic-03.md` - Numbering & Versioning Framework
- **Epic 4:** `docs/kanban/epics/epic-04/epic-04.md` - Kanban Framework
