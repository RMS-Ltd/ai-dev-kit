...
That work shipped across [BR-090](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/docs/project-management/kanban/fr-br/BR-090-docusaurus-faster-missing-dependabot-310-lockfile-drift.md) (dependency alignment) and a full corpus link remediation wave (**v0.5.9.13+2** through **+4**).
