...
def render_markdown() -> str:
    ...
    lines = [
        ...
        "together with the AI Dev Kit SemVer banner ([UXR-016](https://github.com/RMS-Ltd/ai-dev-kit/blob/main/docs/kanban/fbu/UXR-016-install-setup-interactive-feedback-external-semver-version.md)).",
        "",
