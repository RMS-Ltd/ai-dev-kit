...
This directory hosts **portable `SKILL.md` files** for optional integration with the ECC harness layer ([FR-098](../../../../docs/kanban/fbu/FR-098-ecc-optional-harness-layer-integration.md)).
