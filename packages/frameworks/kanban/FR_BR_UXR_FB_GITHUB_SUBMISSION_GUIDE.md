...
- BR document is created in `docs/kanban/fbu/`
...
- FR document is created in `docs/kanban/fbu/`
- Issue is commented with document link
...
- UXR document is created in `docs/kanban/fbu/`
- Issue is commented with document link
...
**Status (2026-03-30):** The GitHub Actions workflow that converted issues to `fr-br` documents is **disabled**. It was defined in [`.github/workflows/fr-br-intake.yml.DISABLED`](../../../.github/workflows/fr-br-intake.yml.DISABLED) because GitHub continued to **schedule runs on every push** even though the workflow declared `on: issues` only (see [BR-053](../../../docs/kanban/fbu/BR-053-github-actions-workflow-push-trigger-bug.md), [E2:S11:T12](../../../docs/kanban/epics/epic-02/story-11-intake-workflow-automation/T12-github-actions-workflow-bug-resolution.md)). **Use manual intake:** the [intake-process](../../../.cursor/skills/intake-process/SKILL.md) skill / maintainer process until the workflow is re-enabled after a verified GitHub-side fix.
...
3. **Document Creation:** A new document is created in `docs/kanban/fbu/`
...
1. **Check Path:** Documents are in `docs/kanban/fbu/`
