...
# Epic 1, Story 2, Task 2: Document versioning policy
...
**Format:** `E01:S02:T02` (e.g., `E04:S11:T01`)
...
- **[E01:S02:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E01:S02:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
