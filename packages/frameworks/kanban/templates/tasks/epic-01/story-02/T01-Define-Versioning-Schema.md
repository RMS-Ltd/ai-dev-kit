...
# Epic 1, Story 2, Task 1: Define versioning schema (e.g., RC.EPIC.STORY.TASK+BUILD)

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.1.2.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E01:S02:T01` (e.g., `E04:S11:T01`)
...
Define versioning schema (e.g., RC.EPIC.STORY.TASK+BUILD) for the {PROJECT_NAME} project.
...
- define versioning schema (e.g., rc.epic.story.task+build) requirements
...
- define versioning schema (e.g., rc.epic.story.task+build) completed
...
- [ ] Define versioning schema (e.g., RC.EPIC.STORY.TASK+BUILD) completed successfully
...
1. Analyze requirements for define versioning schema (e.g., rc.epic.story.task+build)
2. Design approach and plan
3. Implement define versioning schema (e.g., rc.epic.story.task+build)
4. Test and validate
...
- **[E01:S02:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E01:S02:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
