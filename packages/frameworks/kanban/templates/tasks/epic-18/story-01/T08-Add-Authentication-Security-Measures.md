...
# Epic 18, Story 1, Task 8: Add authentication security measures

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.1.8+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S01:T08` (e.g., `E04:S11:T01`)

**Full Task ID:** `E18:S01:T08`
...
- **[E18:S01:T08: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S01:T08: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
