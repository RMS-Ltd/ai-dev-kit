...
# Epic 10, Story 3, Task 3: Create seed data system

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.10.3.3+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E10:S03:T03` (e.g., `E04:S11:T01`)
...
Create seed data system for the {PROJECT_NAME} project.
...
- create seed data system requirements
...
- create seed data system completed
...
- [ ] Create seed data system completed successfully
...
1. Analyze requirements for create seed data system
2. Design approach and plan
3. Implement create seed data system
4. Test and validate
...
- **[E10:S03:T03: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E10:S03:T03: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
