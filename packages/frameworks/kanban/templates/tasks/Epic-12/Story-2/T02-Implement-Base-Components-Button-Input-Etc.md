...
**Last updated:** [YYYY-MM-DD] (v0.12.2.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E12:S02:T02` (e.g., `E04:S11:T01`)
...
Implement base components (Button, Input, etc.) for the {PROJECT_NAME} project.
...
- implement base components (button, input, etc.) requirements
...
- implement base components (button, input, etc.) completed
...
- [ ] Implement base components (Button, Input, etc.) completed successfully
...
1. Analyze requirements for implement base components (button, input, etc.)
2. Design approach and plan
3. Implement implement base components (button, input, etc.)
4. Test and validate
...
- **[E12:S02:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E12:S02:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
