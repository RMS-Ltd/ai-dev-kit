...
**Last updated:** [YYYY-MM-DD] (v0.12.1.5+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E12:S01:T05` (e.g., `E04:S11:T01`)
...
Set up routing (if SPA) for the {PROJECT_NAME} project.
...
- set up routing (if spa) requirements
...
- set up routing (if spa) completed
...
- [ ] Set up routing (if SPA) completed successfully
...
1. Analyze requirements for set up routing (if spa)
2. Design approach and plan
3. Implement set up routing (if spa)
4. Test and validate
...
- **[E12:S01:T05: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E12:S01:T05: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
