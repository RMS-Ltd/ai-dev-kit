...
**Format:** `E09:S02:T01` (e.g., `E04:S11:T01`)
...
Create user manual/guide for the {PROJECT_NAME} project.
...
- create user manual/guide completed
...
- [ ] Create user manual/guide completed successfully
...
1. Analyze requirements for create user manual/guide
2. Design approach and plan
3. Implement create user manual/guide
4. Test and validate
...
- **[E09:S02:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S02:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
