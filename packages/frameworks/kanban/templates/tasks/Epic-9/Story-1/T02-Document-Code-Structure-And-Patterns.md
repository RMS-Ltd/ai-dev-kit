...
**Format:** `E09:S01:T02` (e.g., `E04:S11:T01`)
...
Document code structure and patterns for the {PROJECT_NAME} project.
...
- document code structure and patterns completed
...
- [ ] Document code structure and patterns completed successfully
...
1. Analyze requirements for document code structure and patterns
2. Design approach and plan
3. Implement document code structure and patterns
4. Test and validate
...
- **[E09:S01:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S01:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
