...
# Epic 9, Story 1, Task 5: Create contribution guidelines
...
**Format:** `E09:S01:T05` (e.g., `E04:S11:T01`)
...
Create contribution guidelines for the {PROJECT_NAME} project.
...
- create contribution guidelines requirements
...
- create contribution guidelines completed
...
- [ ] Create contribution guidelines completed successfully
...
1. Analyze requirements for create contribution guidelines
2. Design approach and plan
3. Implement create contribution guidelines
4. Test and validate
...
- **[E09:S01:T05: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S01:T05: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
