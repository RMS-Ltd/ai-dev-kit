...
**Format:** `E09:S01:T01` (e.g., `E04:S11:T01`)
...
Create architecture documentation for the {PROJECT_NAME} project.
...
- [ ] Create architecture documentation completed successfully
...
1. Analyze requirements for create architecture documentation
2. Design approach and plan
3. Implement create architecture documentation
4. Test and validate
...
- **[E09:S01:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S01:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
