...
# Epic 11, Story 3, Task 2: Create API usage examples

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.11.3.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E11:S03:T02` (e.g., `E04:S11:T01`)
...
Create API usage examples for the {PROJECT_NAME} project.
...
- create api usage examples requirements
...
- create api usage examples completed
...
- [ ] Create API usage examples completed successfully
...
1. Analyze requirements for create api usage examples
2. Design approach and plan
3. Implement create api usage examples
4. Test and validate
...
- **[E11:S03:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E11:S03:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
