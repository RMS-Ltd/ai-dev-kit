...
# Epic 11, Story 3, Task 1: Generate API documentation (OpenAPI/Swagger)

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.11.3.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E11:S03:T01` (e.g., `E04:S11:T01`)
...
Generate API documentation (OpenAPI/Swagger) for the {PROJECT_NAME} project.
...
- generate api documentation (openapi/swagger) requirements
...
- generate api documentation (openapi/swagger) completed
...
- [ ] Generate API documentation (OpenAPI/Swagger) completed successfully
...
1. Analyze requirements for generate api documentation (openapi/swagger)
2. Design approach and plan
3. Implement generate api documentation (openapi/swagger)
4. Test and validate
...
- **[E11:S03:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E11:S03:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
