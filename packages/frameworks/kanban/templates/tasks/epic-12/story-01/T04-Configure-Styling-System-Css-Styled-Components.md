...
**Last updated:** [YYYY-MM-DD] (v0.12.1.4+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E12:S01:T04` (e.g., `E04:S11:T01`)
...
Configure styling system (CSS/styled-components) for the {PROJECT_NAME} project.
...
- configure styling system (css/styled-components) requirements
...
- configure styling system (css/styled-components) completed
...
- [ ] Configure styling system (CSS/styled-components) completed successfully
...
1. Analyze requirements for configure styling system (css/styled-components)
2. Design approach and plan
3. Implement configure styling system (css/styled-components)
4. Test and validate
...
- **[E12:S01:T04: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E12:S01:T04: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
