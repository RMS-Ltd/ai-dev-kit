...
# Epic 18, Story 1, Task 6: Add two-factor authentication (optional)

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.1.6+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S01:T06` (e.g., `E04:S11:T01`)

**Full Task ID:** `E18:S01:T06`

---

## Scope

Add two-factor authentication (optional) for the {PROJECT_NAME} project.
...
- add two-factor authentication (optional) requirements
...
- add two-factor authentication (optional) completed
...
- [ ] Add two-factor authentication (optional) completed successfully
...
1. Analyze requirements for add two-factor authentication (optional)
2. Design approach and plan
3. Implement add two-factor authentication (optional)
4. Test and validate
...
- **[E18:S01:T06: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S01:T06: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
