...
# Epic 18, Story 1, Task 7: Implement session management

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.1.7+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
- **[E18:S01:T07: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S01:T07: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
