...
**Last updated:** [YYYY-MM-DD] (v0.18.1.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S01:T01` (e.g., `E04:S11:T01`)
...
- **[E18:S01:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S01:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
