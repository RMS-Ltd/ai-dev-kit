...
# Epic 18, Story 2, Task 6: Create admin/user role management

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.18.2.6+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S02:T06` (e.g., `E04:S11:T01`)

**Full Task ID:** `E18:S02:T06`

---

## Scope

Create admin/user role management for the {PROJECT_NAME} project.
...
- create admin/user role management requirements
...
- create admin/user role management completed
...
- [ ] Create admin/user role management completed successfully
...
1. Analyze requirements for create admin/user role management
2. Design approach and plan
3. Implement create admin/user role management
4. Test and validate
...
- **[E18:S02:T06: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S02:T06: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
