...
**Last updated:** [YYYY-MM-DD] (v0.18.2.2+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E18:S02:T02` (e.g., `E04:S11:T01`)
...
Implement role-based access control (RBAC) for the {PROJECT_NAME} project.
...
- implement role-based access control (rbac) requirements
...
- [ ] Implement role-based access control (RBAC) completed successfully
...
1. Analyze requirements for implement role-based access control (rbac)
2. Design approach and plan
3. Implement implement role-based access control (rbac)
4. Test and validate
...
- **[E18:S02:T02: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S02:T02: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
