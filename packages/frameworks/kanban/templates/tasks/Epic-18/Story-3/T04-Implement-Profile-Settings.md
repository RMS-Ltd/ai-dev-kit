...
# Epic 18, Story 3, Task 4: Implement profile settings
...
- **[E18:S03:T04: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E18:S03:T04: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
