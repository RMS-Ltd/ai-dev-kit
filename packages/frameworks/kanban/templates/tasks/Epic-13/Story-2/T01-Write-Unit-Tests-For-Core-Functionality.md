...
**Last updated:** [YYYY-MM-DD] (v0.13.2.1+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E13:S02:T01` (e.g., `E04:S11:T01`)
...
Write unit tests for core functionality for the {PROJECT_NAME} project.
...
- [ ] Write unit tests for core functionality completed successfully
...
1. Analyze requirements for write unit tests for core functionality
2. Design approach and plan
3. Implement write unit tests for core functionality
4. Test and validate
...
- **[E13:S02:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E13:S02:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
