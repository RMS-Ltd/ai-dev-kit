...
# Epic 7, Story 5, Task 5: Communicate insights to product and engineering teams

> **Example:** See `packages/frameworks/kanban/examples/Task-001-Example-Separate-File.md` for a complete example of this template in use.

**Status:** [TODO/IN PROGRESS/COMPLETE]  
**Priority:** [HIGH/MEDIUM/LOW]  
**Last updated:** [YYYY-MM-DD] (v0.7.5.5+0 – [summary])  
**Started:** [YYYY-MM-DD]  
...
**Format:** `E07:S05:T05` (e.g., `E04:S11:T01`)
...
Communicate insights to product and engineering teams for the {PROJECT_NAME} project.
...
- communicate insights to product and engineering teams requirements
...
- communicate insights to product and engineering teams completed
...
- [ ] Communicate insights to product and engineering teams completed successfully
...
1. Analyze requirements for communicate insights to product and engineering teams
2. Design approach and plan
3. Implement communicate insights to product and engineering teams
4. Test and validate
...
- **[E07:S05:T05: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E07:S05:T05: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
