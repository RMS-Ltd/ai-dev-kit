...
# Epic 9, Story 3, Task 3: Add API usage examples
...
Add API usage examples for the {PROJECT_NAME} project.
...
- add api usage examples completed
...
- [ ] Add API usage examples completed successfully
...
1. Analyze requirements for add api usage examples
2. Design approach and plan
3. Implement add api usage examples
4. Test and validate
...
- **[E09:S03:T03: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S03:T03: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
