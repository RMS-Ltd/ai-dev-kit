...
# Epic 9, Story 3, Task 1: Generate API documentation (OpenAPI/Swagger)
...
**Format:** `E09:S03:T01` (e.g., `E04:S11:T01`)
...
- **[E09:S03:T01: Task Title](path/to/task.md)** - **Relationship Type:** [Complements/Coordinates With/Informs/Follows/Precedes/Related To] - **Context:** [Why tasks are related]
...
**Related Tasks:**
- [E09:S03:T01: Related Task Title](path/to/task.md) — *Bidirectional: task must link back to this task*
